...
<body>
    <div class="container-fluid">
            ...
            <div class="col-2 sidebar">
                ...
                <nav>
                    ...
                    <div class="collapse" id="ticketdropdown">
                        <a href="#" class="nav-link active">Raised Tickets</a>
                        <a href="manageticket" >Manage Ticket</a>
        ...
        <a href="manageticket"> <button type="button" class="btn btn-outline-success" style="width:250px;height:50px;margin-left:26.5cm;">Click to allocate the Supervisor</button></a>   
            <br>
            <br>
            <br>
