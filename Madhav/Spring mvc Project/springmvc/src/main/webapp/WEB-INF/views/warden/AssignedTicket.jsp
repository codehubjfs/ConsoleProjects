            ...
            <div class="col-2 sidebar">
                ...
                <nav>
                    ...
                    <div class="collapse" id="ticketdropdown">
                        <a href="viewticket">View Tickets</a>
                        <a href="manageticket">Manage Ticket</a>
                        <a href="manageticket"  class="nav-link active" >Assigned Tickets</a>
                    </div>
                        ...
                        <div class="card animate__animated animate__fadeInUp">
                            <div class="card-body">
                                ...
                                <table id="ticketsTable" class="table table-hover table-bordered responsive nowrap">
                                    ...
                                    <tbody>
                                        <c:forEach items="${assignedTicket}" var="ticket" varStatus="status">
