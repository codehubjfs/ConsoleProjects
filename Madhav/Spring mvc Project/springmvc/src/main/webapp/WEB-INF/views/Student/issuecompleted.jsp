        ...
        <div class="row">
            ...
            <div class="col-2 sidebar">
                ...
                <nav>
                    ...
                    <a href="${pageContext.request.contextPath}//Sdashboard" class="nav-link active">
                        ...
                        <div class="dropdownprofile">
                            ...
                            <div class="dropdown-container" id="dropdownContainer">
                                <div class="profile-info">
                                    <img src="../../asserts/image/student/student.jpg" alt="User Profile">
                                    <div class="details">
	                                    <c:forEach items="${ProfileOverview}" var="profile" >
	                                    	<h3>${profile.name}</h3>
	                                    	<p>${profile.mailid}</p>
            ...
            <div class="row1">
                <h3>Total Issues Raised by past two months</h3>
