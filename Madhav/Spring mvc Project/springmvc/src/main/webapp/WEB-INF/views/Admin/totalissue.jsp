            ...
            <div class="col-10 main-content">
                ...
                <div style="display:flex;">
	                <button id="export-pdf" class="btn btn-outline-dark btn-sm" style="margin-right:10px;">Export to PDF</button>
		               ...
		               <a href="completedissue"><button type="button" class="btn btn-outline-dark" style="margin-left:23.6cm;">Click to view Completed Issue</button></a>
