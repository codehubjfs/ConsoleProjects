...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/asserts/css/admin/wardenmanagement.css">
...
<body>
    <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="header">
                            ...
                            <div class="toast-container mt-5" id="toast-msg-top" style="margin-left:23cm;">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                       ...
                       <li class="breadcrumb-item "><a href="admindashboard">Dashboard</a></li>
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Warden Management </li>
                    </ol>
                </nav>
		...
		<br>
		 ...
		 <button type="button" class="btn btn-primary mb-3" onclick="showAddWardenForm()" style="margin-left:28.8cm;">Add Warden</button>
	
	
	
	 <p id="warden-added" style="display:none;">${studentinserted}</p>
	...
	<p id="insert-warden" style="display:none;">${InsertWarden}</p>
       	
       
    </div>
	<div id="addStudentForm" class="modal">
                    <form action="insertWarden" method="post" class="needs-validation" novalidate>
                       <div class="section-title">Warden Information</div>
                       <div class="form-group">  
	                        <div class="row mb-3">
	                            <div class="col-md-3">
	                                <label class="Name">Name <span style="color:red;">*</span></label>
	                                <input type="text" name="wardenName" id="wardenName" class="form-control" placeholder="Name" required>
				...
				<div style="width:1250px;margin-left:7cm;margin-top:-30px;">
                        ...
                        <tbody>
                        	<c:forEach items="${wardendetails}" var="warden" varStatus="status">
	                      		<tr data-item-id="${warden.wardenid}">
	                      			...
	                      			<td>${status.count}</td>
	                      			<td class="wardenname">${warden.name}</td>
	                      			<td style="width:350px;">${warden.mailid}</td>
    ...
    <div class="modal fade" id="editUserModal" tabindex="-1" role="dialog" aria-labelledby="editUserModalLabel" aria-hidden="true">
       ...
       <form id="editUserForm" action="editWarden" method="get">
    ...
    <script>
    	const current_status=document.getElementById('insert-warden');
    	console.log(current_status);
    	if(current_status.innerHTML!==null){
    		if(current_status.innerHTML==='success'){
    			showToast("Warden added Successfully",false);
    			current_status.innerHTML==="";
    		}
    		else if(current_status.innerHTML!==''){
    			showToast("Warden added failed",true);
    			current_status.innerHTML==="";
    		}
    	}
   ...
   <script>
    ...
    var mail=[];
 	document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('wardenName').addEventListener('input', validateName);
    ...
    function validateName() {
        var nameInput = document.getElementById('wardenName');
        ...
        if (confirmed) {
            ...
            .then(response => {
                if (response.ok) {
                    ...
                    setTimeout(() => {
                        window.location.href = 'wardenmanagement';
	...
	function editStudent(student){
    	...
    	let warden_name = row.querySelector('.wardenname');
		...
		username.value=warden_name.textContent;    	
    }
</script>
