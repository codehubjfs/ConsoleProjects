            ...
            <br>
             ...
             <div class="ticket-table">
                        ...
                        <div class="card animate__animated animate__fadeInUp">
                            <div class="card-body">
                                <h5 class="card-title">Warden Details</h5>
                                 <table class="table table-striped table-bordered" style="padding:10px;" id="myTable">
                    <thead class="thead-Dark">               
                        ...
                        <tr >
                            ...
                            <th scope="col" style="width:500px;">Mailid</th>
