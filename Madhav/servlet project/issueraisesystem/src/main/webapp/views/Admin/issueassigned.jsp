    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-2 sidebar">
                <div class="logo">
                    <img src="../../asserts/image/admin/ticket-perforated-fill (1).svg" alt="Logo"> 
                    <span>Ticket Raise</span>
                </div>
                <nav>
                    <a href="index.html" id="sidereport">Dashboard</a>
                    ...
                    <div class="collapse" id="userManagementDropdown">
                     ...
                     <a href="reportmanagement.jsp" class="active" id="sidereport">Report Management</a>
                     <a href="${pageContext.request.contextPath}/LogoutController" id="sidereport">Log Out</a>
                 </nav>
            ...
            <div class="col-10 main-content">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Assigned issues</li>
                    </ol>
                </nav>
                ...
                <button id="export-docx" class="btn btn-outline-dark btn-sm">Export to DOCX</button>
                   ...
                   <table id="myTable" class="table table-striped table-bordered">
                    <thead class="thead-Dark">
                        ...
                        <tbody>
                        	 <c:forEach items="${IssueAssigned}" var="ticket" varStatus="status">
