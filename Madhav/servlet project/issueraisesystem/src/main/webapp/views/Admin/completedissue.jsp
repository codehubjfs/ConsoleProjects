                            ...
                            <div class="user-profile">
                                <div class="dropdownprofile">
                                    ...
                                    <div class="dropdown-container" id="dropdownContainer">
                                        ...
                                        <hr>
                                        <a href="${pageContext.request.contextPath}/index.html">Sign Out</a>
                                    </div>
                                </div>
                            </div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item "><a href="${pageContext.request.contextPath}/AdminReportManagementController">Report Management</a></li>
                         <li class="breadcrumb-item "><a href="${pageContext.request.contextPath}/AdminTotalIssueController">Total Issue</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Issue Completed</li>
                    </ol>
                </nav>
