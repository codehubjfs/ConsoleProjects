    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <nav>
                  <a href="${pageContext.request.contextPath}/AdminDashboardController" id="sidereport">Dashboard</a>
                    ...
                    <div class="dropdown dropdowndemo">
                        ...
                        <a href="${pageContext.request.contextPath}/views/Admin/wardenmanagement.jsp">Warden</a>
            ...
            <div class="col-10 main-content">
               ...
               <button type="button" class="btn btn-primary mb-3" onclick="showAddStudentForm()">Add Workers</button>
    ...
    <div id="successMessage" style="display: none;" class="alert alert-success alert-dismissible fade show" role="alert">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                ...
                <div id="addStudentForm" class="modal">
                    <form action="${pageContext.request.contextPath}/AdminAddWorkerController" method="post" class="needs-validation" novalidate>
   ...
   <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
    	...
    	//Checking number is already exicited
    	    fetch('${pageContext.request.contextPath}/WorkerMobileDataController')
    ...
    function deleteStudent(button) {
        ...
        if (confirmed) {
            ...
            console.log(itemId);
            fetch('${pageContext.request.contextPath}/AdminDeleteWorkerController?id=' + itemId, {
                method: 'get'
            })
            .then(response => {
                if (response.ok) {
                    ...
                    setTimeout(() => {
                        window.location.href = '${pageContext.request.contextPath}/AdminWorkerManagementController';
