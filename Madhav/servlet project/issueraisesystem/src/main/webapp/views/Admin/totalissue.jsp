            ...
            <div class="col-2 sidebar">
                ...
                <nav>
                    ...
                    <div class="collapse" id="userManagementDropdown">
                     ...
                     <a href="${pageContext.request.contextPath}/views/Admin/reportmanagement.jsp" class="active" id="sidereport">Report Management</a>
            ...
            <div class="col-10 main-content">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item "><a href="${pageContext.request.contextPath}/AdminDashboardController">Dashboard</a></li>
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Total issue</li>
                    </ol>
                </nav>
                ...
                <div style="display:flex;">
	                ...
	                <button id="export-docx" class="btn btn-outline-dark btn-sm" >Export to DOCX</button>
		               ...
		               <a href="${pageContext.request.contextPath}/AdminIssueCompleted"><button type="button" class="btn btn-outline-dark" style="margin-left:20.5cm;">Click to view Completed Issue</button></a>
                ...
                <br>
                   ...
                   <table id="myTable" class="table table-striped table-bordered">
                    <thead class="thead-Dark">      
                       ...
                       <c:forEach items="${totalissue}" var="ticket" varStatus="status">
