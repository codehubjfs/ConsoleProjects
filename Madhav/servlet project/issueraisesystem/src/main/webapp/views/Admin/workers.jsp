            ...
            <div class="col-2 sidebar">
                ...
                <nav>
                    ...
                    <div class="collapse" id="userManagementDropdown">
                        <a href="usermanagement.html">Student</a>
                        <a href="warden.html">Warden</a>
                        <a href="supervisor.html">Supervisor</a>
                    </div>
                    
                     <a href="Report Management.html" class="active" id="sidereport">Report Management</a>
            ...
            <div class="col-10 main-content">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item "><a href="${pageContext.request.contextPath}/AdminDashboardController">Dashboard</a></li>
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Workers Details</li>
                    </ol>
                </nav>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-center" id="paginationControls">
                        <li class="page-item"><a class="page-link" href="studenttable.html" data-page="1">1</a></li>
