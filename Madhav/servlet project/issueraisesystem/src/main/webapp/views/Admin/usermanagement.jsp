    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-10 main-content">
               ...
               <button type="button" class="btn btn-primary mb-3" onclick="showAddStudentForm()">Add Student</button>
    ...
    <div id="successMessage" style="display: none;" class="alert alert-success alert-dismissible fade show" role="alert">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                ...
                <div id="addStudentForm" class="modal">
                    <form action="${pageContext.request.contextPath}/AdminStudentUserController" method="post" class="needs-validation" novalidate>
   ...
   <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
    	...
    	//Checking number is already exicited
    	    fetch('${pageContext.request.contextPath}/StudentMobileDataController')
    	  ...
    	  //Checking mail id is already there
            ...
            fetch('${pageContext.request.contextPath}/StudentMailController')
	       .then(response => response.json())
	       .then(data => {
	    	   mail = data;
	       })
    ...
    function deleteStudent(button) {
        ...
        if (confirmed) {
            ...
            console.log(itemId);
            fetch('${pageContext.request.contextPath}/StudentDeleteController?id=' + itemId, {
                method: 'get'
            })
            .then(response => {
                if (response.ok) {
                    ...
                    setTimeout(() => {
                        window.location.href = '${pageContext.request.contextPath}/AdminStudentUserController';
