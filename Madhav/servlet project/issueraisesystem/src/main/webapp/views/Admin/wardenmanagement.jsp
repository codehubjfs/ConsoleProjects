...
<body>
    <div class="container-fluid">
		...
		<br>
		 <button type="button" class="btn btn-primary mb-3" onclick="showAddWardenForm()">Add Warden</button>
	...
	<div id="addStudentForm" class="modal">
                    <form action="${pageContext.request.contextPath}/AddWardenController" method="post" class="needs-validation" novalidate>
    ...
    <div class="modal fade" id="editUserModal" tabindex="-1" role="dialog" aria-labelledby="editUserModalLabel" aria-hidden="true">
       ...
       <form id="editUserForm" action="${pageContext.request.contextPath}/EditStudentController" method="get">
 ...
 document.addEventListener('DOMContentLoaded', function() {
    	  ...
    	  //Checking mail id is already there
            ...
            fetch('${pageContext.request.contextPath}/WardentMailController')
    ...
    function deleteStudent(button) {
        ...
        if (confirmed) {
            ...
            console.log(itemId);
            fetch('${pageContext.request.contextPath}/DeleteWardenController?id=' + itemId, {
                method: 'get'
            })
            .then(response => {
                if (response.ok) {
                    ...
                    setTimeout(() => {
                        window.location.href = '${pageContext.request.contextPath}/WardenManagementController';
