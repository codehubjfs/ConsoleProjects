...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/asserts/css/student/oldissue.css">
                ...
                <nav>
                    ...
                    <button class="dropdown-btn"  data-bs-toggle="collapse" data-bs-target="#ticketdropdown" aria-expanded="false" aria-controls="ticketdropdown">
                     ...
                     <div class="collapse" id="ticketdropdown">
                         ...
                         <a href="${pageContext.request.contextPath}//oldissue" class="active">Old ticket</a>
                     </div>
            ...
            <div class="row1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Old tickets</li>
                    </ol>
                </nav>
            </div>
         <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>    
            <div class="row1">
                <h4>Issue Raised by you</h4>
                <div class="input-group searchdetail">
                    ...
                    <span class="input-group-text border-0" id="search-addon">
                        <img src="${pageContext.request.contextPath}/asserts/image/student/search.svg" alt="Search Icon">
                    </span>
                </div>
                <br>
