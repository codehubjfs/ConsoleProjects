...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/asserts/css/student/notification.css">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-2 sidebar">
                <div class="logo">
                    <img src="../../asserts/image/student/ticket-perforated-fill (1).svg" alt="Logo"> 
            ...
            <div class="row1">
                <div class="container mt-5 notifycontainer">
                    <div class="card">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item notification">
                                    ...
                                    <div class="notification-details">	
                                        <div class="notification-title">Ticket #127 Updated</div>
                                        <div class="notification-content">Your ticket has been assigned to a Supervisor.</div>
                                ...
                                <li class="list-group-item notification">
                                    ...
                                    <div class="notification-details">
                                        ...
                                        <div class="notification-content">Today is power off from 10.00am to 2.00pm</div>
                                        <div class="notification-time">1 day ago</div>
                                    </div>
                                </li>
                                <li class="list-group-item notification">
                                    <i class="fas fa-survey notification-icon"></i>
                                    <div class="notification-details">
                                        <div class="notification-title">Ticket #107 Updated</div>
                                        <div class="notification-content">Your ticket has been resolved</div>
                                        <div class="notification-time">1 days ago</div>
                                    </div>
                                    <span class="notification-badge">New</span>
                                </li>
