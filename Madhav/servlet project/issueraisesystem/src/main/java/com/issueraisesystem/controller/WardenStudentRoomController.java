...
/**
 * Servlet implementation class WardenStudentRoomController
 */
public class WardenStudentRoomController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WardenStudentRoomController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (mailid == null) {
			...
			try {
				...
				request.getRequestDispatcher("views/warden/room.jsp").forward(request, response);
