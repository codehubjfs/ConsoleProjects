...
/**
 * Servlet implementation class AdminWorkerManagementController
 */
public class AdminWorkerManagementController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminWorkerManagementController() {
        super();
