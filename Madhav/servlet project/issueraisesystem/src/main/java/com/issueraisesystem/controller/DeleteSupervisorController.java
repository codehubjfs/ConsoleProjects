...
/**
 * Servlet implementation class DeleteSupervisorController
 */
public class DeleteSupervisorController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteSupervisorController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("doi");
		 ...
		 SupervisorDAO supervisorDao=new SupervisorDAO();
			...
			try {
				deleted = supervisorDao.deleteSupervisor(itemId);
	        ...
	        if (deleted) {
	        	...
	        	request.getRequestDispatcher("/DeleteSupervisorController").forward(request, response);
