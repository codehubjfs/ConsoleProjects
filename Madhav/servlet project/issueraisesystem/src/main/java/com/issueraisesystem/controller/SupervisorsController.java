...
/**
 * Servlet implementation class SupervisorsController
 */

@WebServlet("/supervisor")

public class SupervisorsController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			request.getRequestDispatcher("/views/Student/supervisortable.jsp").forward(request, response);
