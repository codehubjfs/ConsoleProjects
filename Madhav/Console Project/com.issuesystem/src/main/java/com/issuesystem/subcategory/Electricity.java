...
import com.issuesystem.userdefinedxception.DateValidatorException;
...
public class Electricity {
	...
	public static void electricityDetails(int key,String username,Scanner sc,String issueTitle) throws SQLException	{	
		boolean electricityFlag=true;
		
		while(electricityFlag) {
			...
			case 1:
				...
				while (dateFlag) {
		            try {
		            	sc.nextLine();
		            	System.out.print("Enter the description (including location):");
