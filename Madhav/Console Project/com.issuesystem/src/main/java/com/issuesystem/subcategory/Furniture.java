...
//	 GET ADMINSTRATIVE DETAILS
	public static void furnitureDetails(int key,String username,Scanner sc,String issueTitle) throws SQLException	{	
		boolean furnitureFlag=true;
		while(furnitureFlag) {
