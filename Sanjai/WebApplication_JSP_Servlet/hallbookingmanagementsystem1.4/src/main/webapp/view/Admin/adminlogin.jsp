...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/assert/css/customerLoginCss.css">
    <link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/assert/css/CustomerHeaderFooter.css">
...
<body>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" id="goHomeBtn">Go to DashBoard</button>
                </div>
            </div>
        </div>
    </div>
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light" id="customNavbar">
            <a class="navbar-brand" href="#"><img src="<%= request.getContextPath() %>/assert/image/Logo.1.1.png" id="company-logo" alt="Company Logo"></a>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="card">
                    ...
                    <form id="loginForm" action="<%= request.getContextPath() %>/AdminLoginServlet" method="post" class="needs-validation" novalidate>
                        <div class="row">
                            <div class="col mb-3">
    ...
    <script>
        ...
        $(document).ready(function() {
           ...
           $('#goHomeBtn').on('click', function() {
    			window.location.href = '<%= request.getContextPath() %>/DashBoardServlet'; // Correctly redirect to DashBoardServlet
			});
