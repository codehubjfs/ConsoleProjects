...
<%@ page import= "com.hallbookingmanagement.dao.CustomerDAO" %>
...
<script src='https://cdn.datatables.net/1.13.5/js/dataTables.bootstrap5.min.js'></script>
    <script>
        ...
        document.querySelectorAll('.save-btn').forEach(button => {
                ...
                location.href = "${pageContext.request.contextPath}/EditCustomerController?status="+statusSelect.value+"&userId="+cid.textContent;
            });
        });
