...
<header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light" id="customNavbar">
            <a class="navbar-brand" href="#"><img src="../assert/image/Logo.1.1.png" id="company-logo" alt="Company Logo"></a>
              ...
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                 ...
                 <div class="dropdown-menu" aria-labelledby="navbarDropdown" id="Events-DropDown">
                    <a class="dropdown-item" href='<%= request.getContextPath() %>/view/hall.jsp'>Wedding</a>
        ...
        <div class="col-8">
            <div class="container">
                <div class="card">
                    ...
                    <form id="registerForm" class="needs-validation" novalidate action="<%= request.getContextPath() %>/RegisterServlet" method="post">
                        <div class="row">
                            <div class="col">
...
<script>
	...
	function validateConfirmPassword() {
	    ...
	    if (confirmPassword.value !== password.value || !passwordRegex.test(confirmPassword.value)) {
	...
	function checkFormValidity() {
	    const isNameValid = validateField(document.getElementById('name'), nameRegex);
	    const isGenderValid = validateGender();
	    const isEmailValid = validateField(document.getElementById('email'), emailRegex);
	    const isPhoneValid = validateField(document.getElementById('phone'), phoneRegex);
	    const isAddressValid = validateField(document.getElementById('address'), addressRegex);
	    const isUsernameValid = validateField(document.getElementById('username'), usernameRegex);
	    const isPasswordValid = validateField(document.getElementById('password'), passwordRegex);
	    const isConfirmPasswordValid = validateConfirmPassword();
	
	    const isFormValid = isNameValid && isGenderValid && isEmailValid && isPhoneValid &&
	                        isAddressValid && isUsernameValid && isPasswordValid && isConfirmPasswordValid;
	...
	document.getElementById('address').addEventListener('input', function() {
	    validateField(this, addressRegex);
	});
	document.getElementById('username').addEventListener('input', function() {
	    validateField(this, usernameRegex);
	});
	...
	document.querySelectorAll('.togglePassword').forEach(function(button) {
	    button.addEventListener('click', function(event) {
	        ...
	        var passwordInput = this.parentElement.parentElement.querySelector('.password');
	        var type = passwordInput.getAttribute('type');
	        var featherIcon = this.querySelector('svg.feather');
	
	        if (type === 'password') {
	            featherIcon.outerHTML = feather.icons["eye-off"].toSvg();
	            passwordInput.setAttribute('type', 'text');
	        } else if (type === 'text') {
	            featherIcon.outerHTML = feather.icons["eye"].toSvg();
