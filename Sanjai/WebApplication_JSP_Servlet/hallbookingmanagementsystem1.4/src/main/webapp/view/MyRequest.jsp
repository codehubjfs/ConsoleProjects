	                ...
	                <div class="innerCard row">
	                    ...
	                    <div class="content col-8">
	                        <div class="hall-content d-flex">
	                            <div class="hall_name pe-4"><strong>${book.hall.hallName}</strong></div>
	                            <div class="hall_location pe-4 ">${book.hall.location}</div> 
	                            <div class="price pe-4"><p><strong>Per day price :</strong>&#8377; ${book.hall.price}</p></div>
	                        </div>
	                        <c:if test="${book.bookStatus == 'PENDING'}">
							    ...
							    <div class="book-c flex-grow-0 flex-shrink-0 mt-2 pe-4 align-items-center">
							      <h3>Request state :<p style="color:red;">Pending</p></h3>
							    </div>
							</c:if>
	                        <div class="booking-content d-flex">
	                            <div class="book-c flex-grow-0 flex-shrink-0 bookeduration pe-4"><strong>Start Date:</strong>${book.startDate}</div>
	                            <c:choose>
	                                <c:when test="${book.bookStatus == 'APPROVED'}">
	                                  <form action="<%= request.getContextPath() %>/PaymentGatewayServlet" method="get">
			                                  <input value="${book.bookingId}" name="bookingID" style="display:none"/>
			                                    <div class="book-c flex-grow-0 flex-shrink-0 mt-2 pe-4 align-items-center">
	                                ...
	                                <form action="<%= request.getContextPath() %>/CancelRequestServlet" method="get">
		                                 	<input value="${book.bookingId}" name="bookingID" style="display:none"/>
		                                    	<div class="book-c flex-grow-0 flex-shrink-0 mt-2 pe-4 align-items-center">
		                                        <button class="btn btn-outline-primary btn-block">Cancel booking</button>
		                                    </div>
	                                     </form>
	                                </c:when>
	                            </c:choose>
