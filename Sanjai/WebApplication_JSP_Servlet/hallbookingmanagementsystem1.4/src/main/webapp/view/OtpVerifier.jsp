...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light" id="customNavbar">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin-left:30% !important">
    ...
    <body>
        <div class="container">
            <div class="subContainer d-flex pb-5" style="border-radius: 30px;">
                <div class="container me-5 ms-5 mb-5">
                    <div class="row justify-content-center align-items-center" style="height: 50vh;">
                        <div class="img-comtainer"><img src="<%= request.getContextPath() %>/assert/image/16191.jpg" width="200px"></div>
                        <form class="row g-3 needs-validation" action="OTPVerifierServlet" method="get" novalidate>
                        <div class="form-group">
                        
                            <p class="text-center">An OTP (One-Time Password) has been sent to your registered email address. Please check your email and enter the OTP below to proceed.</p>
                            <label for="otpInput"><strong style="color: rgb(73, 46, 14);">Enter OTP</strong></label>
                            <input type="number" name="otp" class="form-control" id="otpInput" aria-describedby="inputGroupPrepend" placeholder="Enter OTP" required>
                            <div class="invalid-feedback">
        							Please enter valid the OTP
      						</div>
                        </div>
                        <Div><p class="d-inline mt-5">OTP expires in : </p><div id="stopwatch" class="d-inline">01:00</div></Div>

                        <div class="form-group d-flex justify-content-between m-3">
                          
                            <button type="button" class="btn btn-link" id="resendBtn">Send Me Again</button>
        ...
        <script>
        function startStopwatch(durationInSeconds, displayElement) {
     ...
     // Example starter JavaScript for disabling form submissions if there are invalid fields
        ...
        document.getElementById("otpInput").addEventListener("input", function() {
            var outInput = this.value;
            var feedback = document.querySelector(".invalid-feedback");

            if (outInput.length === 6 && outInput >= 100000 && outInput <= 999999) {
