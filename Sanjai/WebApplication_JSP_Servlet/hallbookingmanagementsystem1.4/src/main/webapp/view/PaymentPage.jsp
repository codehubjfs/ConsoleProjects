...
<!--Logout modal-->
                    ...
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseGPay" class="collapse" aria-labelledby="headingGPay" data-parent="#accordionExample">
                                <div class="card-body">
                                    <input type="text" id="upiIdG" name="upiIdG" class="form-control" placeholder="Upi ID">
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div id="collapsePhonepe" class="collapse" aria-labelledby="headingPhonepe" data-parent="#accordionExample">
                                <div class="card-body">
                                    <input type="text" id="upiIdP" name="upiIdP" class="form-control" placeholder="Upi ID">
                                </div>
                            </div>
                        </div>
                        <div class="card">
    ...
    <div class="card w-100">
        ...
        <div class="p-3">
            <button class="btn btn-success btn-block free-button ps-5 pe-5" data-toggle="modal" data-target="#enterPinModal"><strong>Pay</strong></button>
        </div>
    </div>
</div>
<!-- Enter PIN Modal -->
<div class="modal fade" id="enterPinModal" tabindex="-1" role="dialog" aria-labelledby="enterPinModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="PaymentPayedServlet" method="get">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <input type="password" id="userPin" name="userPin" class="form-control" placeholder="Enter PIN" autocomplete="off">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-primary" onclick="submitPin()">Submit</button>
                </div>
            </div>
        </form>
    </div>
