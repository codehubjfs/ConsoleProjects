            ...
            <c:forEach items="${hallList}" var="hall" varStatus="status"> 
                ...
                <div class="col-sm"> 
                    <div class="card-container">
                        <div class="card">
	                             <a href="<%= request.getContextPath() %>/HallDetailServlet?hall_id=${hall.hallId}" ><img src="<%= request.getContextPath() %>/assert/image/hallcard-5.jpg" style="border-radius:20px;"></a>
