        ...
        try {
            ...
            for (Book book : bookList) {
                if ((startDate.isBefore(book.getEndDate()) && endDate.isAfter(book.getStartDate())) &&
                        (book.getBookingStatus().equals(BookingStatus.PENDING) || book.getBookingStatus().equals(BookingStatus.APPROVED))) {
            ...
            PreparedStatement blockStatement = DBConnection.getConnection().prepareStatement(blockUpdateQuery);
