...
<body>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-3 col-sm-12 filter-bar">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item filter-by-amenities">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="amenityBar">
                        <label class="form-check-label" for="amenityAudioVisual">Bar</label>
                    </div>
                     <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="amenityIceScreamBar">
                        <label class="form-check-label" for="amenityAudioVisual">Ice Scream Bar</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="amenityAdditionalSecurity">
                        <label class="form-check-label" for="amenityAudioVisual">Additional Security</label>
                    </div>
        ...
        <div class="col-md-9 col-sm-12 " id ="main-container" style="margin-left: 320px; margin-top: 7%; " >
            <div class="row">
            ...
            <c:forEach items="${hallList}" var="hall" varStatus="status"> 
                ...
                <div class="col-sm"> 
                    <div class="card-container">
                        <div class="card">
	                          <a class="hall_link" data-hall-id="${hall.hallId}" data-index="${status.index}">
                    					<img src="<%= request.getContextPath() %>/assert/image/hallcard-5.jpg" style="border-radius:20px;">
                				</a>
	                            <div class="card-content">
	                                <div class="namestar d-flex mt-2">
	                                    <h4 style="text-decoration:none;">${hall.hallName}</h4>
	                                        <div class="rating d-inline">
	                                            <img src="<%= request.getContextPath() %>/assert/image/star_148841.png" style="width:20px;">
	                                            <p class="d-inline" style="margin-right: 20px;">4.5</p>
	                                        </div>
	                                </div>
	                                <div class="location d-flex d-block">
	                                    <img src="<%= request.getContextPath() %>/assert/image/placeholder_186250.png">
	                                    <p>${hall.location}</p>
	                                </div>
	                                        <div class="price ms-2">
	                                            <p><strong>&#8377;${hall.price}</strong>Per Day</p>
	                                        </div>
	                                        <div class="capacity ms-2">
	                                            <p><strong>${hall.capacity} </strong> Aprox</p>
	                                        </div >
	                                        <div class="amenties d-flex ms-2">
	                                            <c:forEach items="${hall.amenities}" var="amenity" varStatus="amenityStatus">
	                                    			<c:if test="${amenityStatus.index < 3}">
                        	 ...
                        	 <form id="form-${status.index}" style="display:none" class="submission" action="showHallDetail" method="post">
				                <input name="hallId" id="hall-Id-${status.index}" value="${hall.hallId}">
