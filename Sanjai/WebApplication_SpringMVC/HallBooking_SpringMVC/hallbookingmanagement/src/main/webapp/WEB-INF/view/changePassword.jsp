        ...
        <div class="subContainer d-flex pb-5" style="border-radius: 30px;">
            <div class="container me-5 ms-5 mb-5">
                <div class="row justify-content-center align-items-center" style="height: 50vh;">
                    <div class="img-container"><img src="<%= request.getContextPath() %>/assert/image/14562381_5500661.jpg" width="200px"></div>
                    <div class="form-group">
                        <form class="row g-3 needs-validation" action="changePassword" method="post" novalidate>
                            <label for="password"><strong style="color: rgb(73, 46, 14);">Enter New Password</strong></label>
                            <input type="password" name="password" class="form-control" id="password" aria-describedby="inputGroupPrepend" placeholder="Enter new Password" required>
                            <div class="invalid-feedback">Password must be at least 8 characters long and contain at least one letter, one number, and one special character.</div>
                           	<input value="${sessionScope.mail}"  name ="mail" style="display:none";>
                        </form>
                    </div>
                    <div class="form-group d-flex justify-content-between m-3">
                        <button type="submit" class="btn btn-primary" id="nextBtn">Change Password</button>
                    </div>
                </div>
            </div>
        </div>
