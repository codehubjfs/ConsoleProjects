        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="card">
                    ...
                    <form id="loginForm" action="adminlogin" method="post" class="needs-validation" novalidate>
                        <div class="row">
                            <div class="col mb-3">
    ...
    <script>
        ...
        $(document).ready(function() {
           ...
           $('#goHomeBtn').on('click', function() {
    			window.location.href = '<%= request.getContextPath() %>/dashBoard'; // Correctly redirect to DashBoardServlet
			});
