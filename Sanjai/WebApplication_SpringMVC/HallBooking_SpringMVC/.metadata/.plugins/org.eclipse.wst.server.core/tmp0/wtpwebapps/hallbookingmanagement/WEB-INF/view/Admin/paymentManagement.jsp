 ...
 <form action="logout" method="get">
  <div class="modal-dialog">
    ...
    <div class="subContainer">
        ...
        <div class="mainContent" style="margin-left:250px ; margin-top:40px !important">
            <h1>Payment Details</h1>
                            <button id="export-pdf" class="btn btn-outline-dark btn-sm mb-3 mt-3">Export to PDF</button>
            <div class="table-responsive-lg">
                <table id="paymentTable" class="table table-hover table-bordered"  style="width:70%;">
                    ...
                    <c:forEach items="${paymentList}" var="payment" varStatus="status">
                        <tr>
                            ...
                            <td class ="payment-status">${payment.paidStatus}</td>
                        </tr>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        var paymentStatusElements = document.getElementsByClassName("payment-status");
        
        for (var i = 0; i < paymentStatusElements.length; i++) {
            var paymentStatus = paymentStatusElements[i].textContent;
            
            if (paymentStatus === "ADVANCED") {
                paymentStatusElements[i].style.color = "orange";
            }
            
            if (paymentStatus === "PAID") {
                paymentStatusElements[i].style.color = "green";
            }
        }
