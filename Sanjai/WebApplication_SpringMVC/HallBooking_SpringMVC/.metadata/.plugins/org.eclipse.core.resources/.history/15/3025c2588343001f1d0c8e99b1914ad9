    ...
    <div class="modal fade" id="successModal" tabindex="-1" role="dialog" aria-labelledby="successModalLabel" aria-hidden="true">
       ...
       <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light" id="customNavbar">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin-left:20% !important">
        ...
        <div class="col-md-5">
            <div class="card">
               ...
               <form id="loginForm" action="login" method="post" class="needs-validation" novalidate>
                    <div class="row">
                    	<input type="hidden" name="redirectAfterLogin" value="<%= session.getAttribute("redirectAfterLogin") %>" />
                        <div class="col mb-3">
                    ...
                    <div class="new-account">
                        <p>Don't have an account? <a id="createAccount" class="link-primary">Create a new account</a></p>
                    </div>
                    <div class="hr-with-text">
                        <span>Are you an Admin?</span>
                    </div>
                    <div class="d-flex justify-content-center">
                       <a style="text-decoration:none;"><button class="btn btn-outline-dark d-flex align-items-center" id="admin-login">
                                Business Sign In
                       </button></a>
                    </div>
                </form>
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <form id="resetPasswordForm" class="needs-validation" action="forgetPassword" method="get" novalidate>
...
<div class="modal" id="invalidMail" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body mt-2 mb-2">
        <h4>Entered Email Id is not Existed</h4>
      </div>
      <div class="modal-footer">
    ...
    $(document).ready(function() {
        ...
        $('#admin-login').on('click', function(event) {
            ...
            window.location.href = '<%= request.getContextPath() %>/viewAdminLogin'; // Correctly redirect to admin login page
        });
  ...
  <% if(request.getAttribute("emailNotExisted") != null) { %>
        $('#invalidMail').modal('show');
 <% } %>

    document.getElementById("createAccount").addEventListener("click", function(){
    	event.preventDefault(); 
    	window.location.href = "<%= request.getContextPath() %>/viewRegister";
    })
    </script>
</body>
</html>
