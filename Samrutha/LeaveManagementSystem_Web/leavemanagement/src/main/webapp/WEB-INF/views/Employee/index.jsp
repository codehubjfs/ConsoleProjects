...
<%@page import="com.leavemanagement.model.LeaveBalance"%>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <nav class="col-sm-2 sidebar sidebar-sticky">
                <a class="nav-link active" href="${pageContext.request.contextPath}/employee/edashboard">Dashboard</a>
            ...
            <div class="col-sm-10 content">
                        ...
                        <div class="col-md-2 col-sm-6" class="cardTrans">
							<div class="card">
							    <div class="card-body">
							      ...
							      <p class="card-text" id="sickleave"> ${15 - leaveBalance.sickLeave}</p>
							    </div>
							</div>
							</div>
							...
							<div class="card">
							    <div class="card-body">
							      ...
							      <p class="card-text" id="casualleave">${15 - leaveBalance.casualLeave}</p>
							    </div>
							</div>
							</div>
							<div class="col-md-2 col-sm-6">
							<div class="card">
							    <div class="card-body">
							      ...
							      <p class="card-text" id="vacationleave">${15 - leaveBalance.vacationLeave}</p>
							    </div>
							</div>
							</div>
							<div class="col-md-2 col-sm-6">
							<div class="card">
							    <div class="card-body">
							      ...
							      <p class="card-text">${leaveBalance.balanceLeave}</p>
							    </div>
							</div>
							</div>
							...
							<div class="card">
							    <div class="card-body">
							      ...
							      <tr>
							      	<td style="margin-left:10px;">Sick Leave:</td>
							      	<td>15</td>
							      </tr>
							      <tr>
							      	<td>Casual Leave:</td>
                ...
                <div class="row">
                    <div class="col-lg-7" class="cardTrans" style="width:650px">
                        <div class="card">
                            <div class="card-body">
                              ...
                              <div class="table-responsive">
			                    ...
			                    <tbody>
								    <% 
								        ...
								        List<Leaves> pendingLeaves = leaves.stream().filter((l) -> l.getStatus().equals(ApplicationStatus.PENDING) && (l.getStartDate().isAfter(LocalDate.now()) && l.getStartDate().isEqual(LocalDate.now()))).collect(Collectors.toList());
								        ...
								        <c:when test="${not empty pendingLeaves}">
								            <c:forEach var="leave" items="${pendingLeaves}" varStatus="status">
								                <tr>
								                    ...
								                    <td>
								                        <a href="${pageContext.request.contextPath}/employee/eleave" style="color: #040430;">
			                ...
			                <div class="more">
	                            <a href="${pageContext.request.contextPath}/employee/eleave">View More</a>
	                        </div>
                              </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6" class="cardTrans" style= "width:345px;">
