...
<head>
    ...
    <style>
        ...
        .card {
            ...
            border-radius: 20px;
            margin-bottom: 2rem;
            width: 280px; /* Set the width of each card */
            height: 410px;
            display: flex;
...
<body>
    ...
    <div class="row">
        <nav class="col-md-2 sidebar sidebar-sticky">
            ...
            <a class="nav-link active" href="${pageContext.request.contextPath}/manager/mLeaveManagement">Leave Management</a>
            <a class="nav-link" href="${pageContext.request.contextPath}/manager/mviewTeams">View Team</a>
                ...
                <div class="card">
                    <div class="card-title">
                        <div class="content-container">
                            ...
                            <div>
                                ...
                                <p class="text"> <%= l.getEmp().getDepartment().getDeptName() %></p>
                            </div>
                        </div>
                    </div>
                    <div class="card-body" id="leave-body">
                        ...
                        <div>
                            ...
                            <textarea cols="43" rows="5" style="font-size: 12px; resize: none;" readonly><%= l.getReason() %></textarea>
                        </div>
                        <div class="d-flex justify-content-between" style="padding:5px; padding-top:5px;padding-bottom:5px;">
			                    ...
			                    <button type="button" class="btn btn-warning btn-sm mx-1" data-bs-toggle="modal" data-bs-target="#reassignModal" data-leave-type="<%= l.getLeaveType() %>" data-leave-id="<%= l.getLeaveId() %>" data-user-name="<%= l.getEmp().getUsername() %>">Assign&Approve</button>
    ...
    <div class="modal-dialog" style="width: 26rem;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="rejectForm" action="${pageContext.request.contextPath}/leaves/rejectLeave" method="post">
   ...
   <div class="modal fade" id="approveModal" tabindex="-1" aria-labelledby="approveModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="width: 26rem; align-items: center;">
        <div class="modal-content" style="align-items: center; justify-content: center;">
            ...
            <div class="modal-footer">
                <form id="approveForm" action="${pageContext.request.contextPath}/leaves/approveLeave">
...
<div class="modal fade" id="reassignModal" tabindex="-1" aria-labelledby="reassignModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="width: 26rem; align-items: center;">
        <div class="modal-content" style="align-items: center; justify-content: center;">
            ...
            <div class="modal-body">
                <form id="reassignForm" action="${pageContext.request.contextPath}/leaves/reassignApproveLeave">
