...
<body>
    ...
    <div class="row">
        <nav class="col-md-2 sidebar sidebar-sticky">
            ...
            <a class="nav-link active" href="${pageContext.request.contextPath}/manager/mviewTeams">View Team</a>
                  ...
                  <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 card-container">
                    <div class="card" style="height: 22rem;">
                      <div class="team-image-wrapper">
                        <img class="team-member-image" src="${pageContext.request.contextPath}/asserts/images/image3.png">
                      </div>
                      ...
                      <p class="text-blk feature-text">
                      	<%= team.getDepartment().getDeptName() %>
                      </p>
