...
<body>
     <header class="header fixed-top">
       ...
       <div class="row">
        <nav class="col-md-2 sidebar sidebar-sticky">
            ...
            <a class="nav-link active" href="${pageContext.request.contextPath}/manager/mprofile">Profile</a>
	    ...
	    <div class="modal-dialog" role="document">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                <form id="leaveForm" action="updateMprofile" method="post" onsubmit="return validateForm()">
                    <div class="form-group">
                        <label for="oldpassword" style="margin-left:0px">Old Password</label><br>                               
                        <input type="password" name="oldPassword" id="oldpassword" oninput="clearError('oldPasswordError')" onblur="validateOldPassword()">
	...
	var password='';
			document.addEventListener('DOMContentLoaded',function(){
				...
				fetch('mpasswordchecker').then(response=>response.json()).then(data=>{
					password=data;
