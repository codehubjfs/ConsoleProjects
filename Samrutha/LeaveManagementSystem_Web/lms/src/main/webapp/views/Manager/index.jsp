...
<body>
    ...
    <div class="row">
        <nav class="col-md-2 sidebar sidebar-sticky">
            <a class="nav-link active" href="${pageContext.request.contextPath}/mdashboard">Dashboard</a>
            ...
            <a class="nav-link" href="${pageContext.request.contextPath}/viewTeams">View Teams</a>
            <a class="nav-link" href="${pageContext.request.contextPath}/calender">Calendar</a>
        ...
        <div class="col-md-10 content">
          ...
          <div class="activity">
            ...
            <a href="${pageContext.request.contextPath}/requestLeave">
                <div class="card" style="width: 13rem;">
                    <div class="card-body">
          ...
          <div class="col-8 d-flex">
			    <div class="activity" id="tables">
			        <div class="card special-card" style="width: 25rem; height: auto; transform:0s;">
			            <div class="card-body">
			                                    ...
			                                    <div class="modal-content" style="text-align: center; align-items: center; justify-content: center;">
			                                        ...
			                                        <div class="modal-body">
			                                            <div class="card-container" style="background-color: #040430; border-radius: 5px; box-shadow: 0px 10px 20px -10px rgba(0,0,0,0.75); color: #B3B8CD; padding-top: 30px; padding-bottom: 20px; position: relative; width: 300px; max-width: 100%; text-align: center;">
			                                                <img class="round" src="${pageContext.request.contextPath}/asserts/images/image2.svg" alt="user" style="border: 1px solid #03BFCB; border-radius: 50%; height: 50%; width: 50%; padding: 7px;"/>
			                                                <h3 style="margin: 10px 0;">${employee.firstName} ${employee.lastName}</h3>
			                                                <h6 style="margin: 5px 0;">${employee.role}</h6>
			                                                <h6 style="font-size: 12px; line-height: 21px;">${employee.dept.deptName}</h6>
			                ...
			                <div class="more">
			                    <a href="${pageContext.request.contextPath}/viewTeams">View More</a>
			                </div>
			            </div>
			        </div>
			    </div>
                ...
                <div class="col-md-8">
                    <div class="activity">
                        <div class="card" style="width: 25rem; height: 18rem;" id="graph">
                            <div class="card-body">
                                <div>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content" style="text-align: center; align-items: center; justify-content: center;">
            ...
            <div class="modal-body">
                <div class="card-container" style="	background-color: #040430;border-radius: 5px;box-shadow: 0px 10px 20px -10px rgba(0,0,0,0.75);color: #B3B8CD;padding-top: 30px;padding-bottom: 20px;position: relative;width: 300px;max-width: 100%;text-align: center;
                ">
                    <img class="round" src="../images/image2.svg" alt="user" style="border: 1px solid #03BFCB;border-radius: 50%;height: 50%; width: 50%; padding: 7px;"/>
                    <h3 style="margin: 10px 0;">Mark Otto</h3>
                    <h6 style="margin: 5px 0;">Employee</h6>
                    <h6 style="font-size: 12px;line-height: 21px; ">Technology Development</h6>
                    <p style="font-size: 14px;line-height: 21px;">Employee Id: 10</p>
                    <p style="font-size: 14px;line-height: 21px;">Email: markotto@gmail.com</p>
                </div>
            </div>
            <div class="modal-footer">
            <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal">Close</button>
