     ...
     <header class="header fixed-top">
       ...
       <div class="row">
        <nav class="col-sm-2 sidebar sidebar-sticky">
                ...
                <a class="nav-link active" href="${pageContext.request.contextPath}/Leave">Applied Leaves</a>
    ...
    <!-- Apply leave -->
	    ...
	    <div class="modal-dialog" role="document">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                <form id="leaveForm" action="${pageContext.request.contextPath}/Application" method="post" onsubmit="return validateForm()">
	                    <div class="form-group">
	                        <label for="leaveType">Leave Type</label>
	                        <select class="form-control" id="leaveType" name="leavetype" onchange="validateForm()">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <input type="date" class="form-control" id="startDate" name="startdate" onchange="validateStartDate(); validateForm()" >
	                        <span id="startDateFeedback" style="color: red;"></span>
	                    </div>
	                    <div class="form-group">
	                        <label for="endDate">End Date</label>
	                        <input type="date" class="form-control" id="endDate" name="enddate" onchange="validateEndDate()">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <textarea class="form-control" id="leaveReason" name="leaveReason" rows="3" onchange="validateLeaveReason(); validateForm()"></textarea>
