...
<nav class="navbar navbar-expand-lg navbar-light sticky-header" id="ids">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-auto mb-lg-0 fs-5 space">
                <li class="nav-item fcolor"><a class="nav-link active fse ms-5" aria-current="page" href="home">Home</a></li>
	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img class="d-block w-100" src="${pageContext.request.contextPath}/Images/booked3.jpeg"
					alt="First slide">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100" src="${pageContext.request.contextPath}/Images/booked2.jpg"
					alt="Second slide">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100" src="${pageContext.request.contextPath}/Images/booked1.jpg"
					alt="Third slide">
			</div>
		</div>
	...
	<div class="marquee-container">
		<marquee behavior="scroll" direction="left" scrollamount="20">
			<img src="${pageContext.request.contextPath}/Images/Screenshot (208).png" alt="Image 1"
				width="140px"> <img src="${pageContext.request.contextPath}/Images/primo.jpg" alt="Image 2"
				width="243px"> <img src="${pageContext.request.contextPath}/Images/sara.jpeg" alt="Image 3"
				height="113px" width="200px"> <img
				src="${pageContext.request.contextPath}/Images/buscom4.jpeg" alt="Image 4" height="113px"
				width="200px"> <img src="${pageContext.request.contextPath}/Images/sky.jpeg" alt="Image 5"
				height="113px" width="200px"> <img src="${pageContext.request.contextPath}/Images/vkv.png"
				alt="Image 6" height="113px" width="200px">
		</marquee>
	</div>
	<div class="read">
		<section
			class="custom-section d-flex justify-content-between p-0 secondhead">
			<div>
				<br>
				<h2>GRAB BUS TICKETS Through OUR WEBSITE</h2>
				<p>Joy Rider is a bus ticketing platform operating since 2024.
					Millions of passengers trust Joy Rider for booking affordable bus
					tickets. By bus registration on redBus, you will boost the brand
					reputation of your travel company. Joy Rider believes in offering
					transparency to its travel partners for better productivity. You
					can widen your customer reach with Joy Rider in no time.</p>
				<p>Joy Rider is your premier choice for convenient and reliable
					bus ticket booking. Whether you are planning a short trip or a long
					journey, our user-friendly platform makes it easy to book your bus
					tickets in just a few clicks.With Joy Rider, you can explore
					various destinations, choose from multiple bus operators, and enjoy
					a seamless booking experience. Our commitment to providing
					excellent customer service ensures that your travel plans are
					hassle-free. Booking your bus tickets has never been easier! Visit
					our website, enter your travel details, and select from a range of
					options tailored to your needs. Experience the ease and convenience
					of online bus ticket booking with Joy Rider. Join our community of
					happy travelers and make your next journey memorable with Joy
					Rider.If you provide bus services to multiple cities, you need to
					open a counter in those cities. Opening ticket counters in many
					cities is hard. With Joy Rider, you can tap the audience from
					various cities without the need for physical ticketing
					counters.Once you complete the joy riderbus registration process,
					you don’t need to worry about service. All Joy rider partners can
					receive personalised support from the joy rider team, from selling
					tickets to payment.</p>
			</div>
		</section>
	</div>
		...
		<footer class="text-center text-lg-start text-black"
			...
			<section class="d-flex justify-content-between p-2"
				...
				<div>
					...
					</a> <a href="" class="cs4 me-4"> <img src="${pageContext.request.contextPath}/Images/insta.png"
						alt="insta" width="25px">
					</a>
				</div>
