...
<head>
    ...
    margin: 0;
    padding: 10px 20px; /* Padding around the navbar */
    background-color: #163c83; /* Your desired background color */
    font-size:25px;
}
        ...
        .navbar img {
            ...
            margin-right: 10px; /* Adjust logo margin */
        }
        ...
        .navbar a {
            ...
            color: #000000; /* Navbar link color */
        }
        ...
        .card {
            ...
            border-radius: 1rem;
            width: 30rem; /* Adjust card width */
            padding: 20px;
            height: 400px; /* Adjust card height */
            margin-left: 100px; /* Adjust left margin */
            background-color: rgb(192, 221, 252); /* Card background color */
        }
        ...
        .form-outline {
            text-align: left; /* Adjust alignment of form elements */
        }
