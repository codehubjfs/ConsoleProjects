...
<body>
	<nav class="navbar navbar-expand-lg navbar-light sticky-header"
		...
		<div class="container-fluid">
			<img src="../../Images/Joylogo.png" alt="logo" width="60px"
				height="50px"> <a
				class="navbar-brand pt-1 p-3 d-flex-align-items-center fs-4"
				href="#"> <span class="text-primary fw-bold pt-2">Joy<span
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mb-auto mb-lg-0 fs-5 space">
					<li class="nav-item fcolor"><a class="nav-link  fse ms-1"
						aria-current="page" href="Home.jsp">Home</a></li>
					<li class="nav-item fcolor"><a
						class="nav-link active fse ms-5" aria-current="page"
						href="About.jsp">About us</a></li>
					<li class="nav-item fcolor"><a class="nav-link fse ms-5"
						aria-current="page" href="Book.jsp">Booking</a></li>
					<li class="nav-item fcolor" id="cancelLink" style="display: none;">
						<a class="nav-link fse ms-5" href="cancelticket.jsp">Cancel
							Booking</a>
					</li>
					<li class="nav-item fcolor" id="viewLink" style="display: none;">
						<a class="nav-link  fse ms-5" href="viewbooking.jsp">View
							Booking</a>
					</li>
                  ...
                  <span class="login-status" id="loginStatus"></span>
					...
					<li class="nav-item fcolor"><a class="nav-link fse ms-5"
						aria-current="page" href="Login.jsp">Login/Register</a></li>
					<li class="nav-item fcolor"><img src="Images/account.png"
						class="mt-1 ms-0" alt="" width="30px"></li>
				</ul>
			</div>
		</div>
	</nav>
	<main>
		...
		<img src="../../Images/tourist.jpg" alt="aboutimage" height="300px"
			width="100%">
		<h5>
			<br>About Us
		</h5>
			...
			<section class="d-flex justify-content-between p-2"
				...
				<div>
					<a href="#" class="cs4 me-4"> <img
						src="../../Images/facebook.png" alt="facebook" width="25px">
					</a> <a href="#" class="cs4 me-4"> <img
						src="../../Images/youtube.png" alt="youtube" width="25px">
					</a> <a href="#" class="cs4 me-4"> <img
						src="../../Images/google.png" alt="google" width="25px">
					</a> <a href="#" class="cs4 me-4"> <img
						src="../../Images/insta.png" alt="instagram" width="25px">
					</a>
				</div>
