  ...
  <nav class="navbar navbar-expand-lg navbar-light sticky-header" id="ids">
    <div class="container-fluid">
        ...
        <a class="navbar-brand pt-1 p-3 d-flex-align-items-center fs-4" href="#">
            <span class="text-primary fw-bold pt-5">Joy<span class="text-success ms-2">R</span>ider</span> 
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mb-auto mb-lg-0 fs-5 space">
                ...
                <li class="nav-item fcolor">
                    <a class="nav-link active fse ms-5" aria-current="page" href="Book.jsp">Booking</a>
                </li>
...
<div class="contains">
       ...
       <!--  <div class="search-container">
                <h3 class="text-center">Online Bus Ticket Booking Site</h3>
        		<form action="${pageContext.request.contextPath}/BusSearchServlet" id="busSearchForm">
          
                <div class="search-box">
                    <div class="input-group">
                        <span class="icon mt-1"><img src="Imagesbook/image4.png" alt="Bus" width="40px" height="40px"></span>
                        <input type="text" name="source" id="fromCity" class="form-control ms-1" placeholder="Source" list="list-source">
      ...
      <option>Theni</option>
                    ...
                    <div class="error" id="fromCityError">Please enter a valid Source city.</div>
                    <br>
                    <div class="input-group">
                        <span class="icon mt-1"><img src="Imagesbook/to.jpg" alt="Bus" width="40px"></span>
                        <input type="text" name="destination" id="toCity" class="form-control" placeholder="Destination" list="list-destination">
                    ...
                    <div class="error" id="toCityError">Please enter a valid Destination city.</div>
                    <br>
                    <div class="input-group">
                        <span class="icon"><img src="Imagesbook/cal.png" alt="Bus" width="50px"></span>
                        <input type="date" id="date" name="travelDate" class="form-control ms-0">
                    </div>
                    <div class="error" id="sameCityError">Source and Destination cities cannot be the same.</div>
                    <br>
                    <button id="searchButton" type="submit" class="btn btn-button srch">SEARCH BUSES</button>
                </div>
           </form>
        </div>
    </div>
...
<div class="container mt-4">
    <div class="card">
        ...
        <div class="card-body">
            <form action="${pageContext.request.contextPath}/BusSearchServlet" method="post" onsubmit="return validateForm()">
                <div class="form-row">
                    <div class="form-group">
                        <label for="source" class="label-with-icon">
                            <img src="../../Images/image4.png" alt="Source Image">
                            Source:
                        </label>
                    ...
                    <div class="form-group">
                        <label for="destination" class="label-with-icon">
                            <img src="${pageContext.request.contextPath}/Images/to.jpg" alt="Destination Image">
                            Destination:
                        </label>
                    ...
                    <div class="form-group">
                     <label for="dateoftravel" class="label-with-icon">
                         <img src="../../Images/cal.png" alt="Source Image">
                       Day of Travel:
                       </label>
...
<hr>
    <div class="container-fluid ins">
         <input type="number" name="customerid" value="${customers.id}" style:"display:none"></input>
        <h1>Instruction for Booking ticket in online</h1>
            <h2>Search for Buses</h2>
            <ol type="1">
            <li>Finding the search from</li>
            <li><span class="gcolor">Source(From):</span>Enter the city or location you are starting your journey from.</li>
            <li><span class="gcolor">Destinations(To):</span>Enter the city or location you are traveling to.</li>
            <li><span class="gcolor">Date : </span>Select your travel date from  the date picker.</li>
            <li>Click on the "SEARCH BUSES" button to proceed.
            </li>
    ...
    <!-- <div class="grid-item"><img src="Imagesbook/bookbus.png" alt="" width="100%" height="100%"></div>  -->
  </div>
<br>
<br>
</div>
      ...
      <section class="d-flex justify-content-between p-2" style="background-color:rgb(241, 240, 247)">
        ...
        <div>
          <a href="" class="cs4 me-4">
            <img src="Imagesbook/face book.png" alt="" width="25px">
          </a>
          <a href="" class="cs4 me-4">
            <img src="Imagesbook/youtube__1_-removebg-preview.png" alt="" width="25px">
          </a>
          <a href="" class="cs4 me-4">
            <img src="Imagesbook/gog.png" alt="" width="25px">
          </a>
          <a href="" class="cs4 me-4">
            <img src="Imagesbook/insa.png" alt="" width="25px">
          </a>
        </div>
