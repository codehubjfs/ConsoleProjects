            ...
            <ul>
                ...
                <li class="submenu">
                    ...
                    <ul id="userManagementSubmenu" style="display: none;">
                        ...
                        <li class="spaceup"><a href="#ch3">- Bus Operator List</a></li>
                    </ul>
                </li>
                <li class="submenu">
                    <a href="${pageContext.request.contextPath}/ViewRoutesController" onclick="toggleSubmenu('routeManagementSubmenu')" class="active">ROUTE MANAGEMENT</a>
                    <ul id="routeManagementSubmenu" style="display: none;">
                        <li class="space"><a href="#ch4">- Route Details</a></li>
                    </ul>
                </li>
                ...
                <li><a href="${pageContext.request.contextPath}/LogoutServlet">LOGOUT</a></li></div>
            </ul>
        </aside>
        <main class="content">
        <h3>Routes</h3><br>
                    ...
                    <tbody>
                       <!--  <tr>
                            ...
                            <td class="action-icons">
                                <i class="bi bi-pencil-square edit-icon" onclick="editAvailability(this)"></i>
                                <img src="../Images/icons8-save-48.png" class="save-icon" title="save" alt="Save" onclick="saveAvailability(this)">
                            </td>
                        </tr> -->
            <c:forEach var="route" items="${routes}" varStatus="status">
                <tr>
                    <td>${status.index + 1}</td>
                    <td class="routeId" style="display:none">${route.index}</td>
                    <td class="source">${route.source}</td>
                    ...
                    <td class="action-column d-flex">
                       <!--  <a href="view/Admin/EditForm.jsp?id=${route.index}" class="edit-link bi bi-pencil-square edit-icon" id="edit-btn"></a> -->
                       <!--  <a href="view/Admin/EditForm.jsp?id=${route.index}" class="edit-link bi bi-pencil-square edit-icon" id="edit-btn"></a>-->
                       <div class="edit-btn">
        <div class="bi bi-pencil-square edit-icon" ></div>
...
<button class="del-btn border border-0 del-btn-custom"><i class="bi bi-trash fs-5"></i></button>
    ...
    <div class="custom-modal-content">
        ...
        <form id="addRouteForm" action="${pageContext.request.contextPath}/AddRoutesController" method="post" onsubmit="return validateForm()">
 ...
 <h4>Edit Availability</h4>
                   <form action="${pageContext.request.contextPath}/UpdateRouteController" method="post">
            <input type="hidden" name="routeId" value="${route.RouteID}">
            <div class="form-group">
                <label for="startLocation">Start Location:</label>
                <input type="text" id="startLocation" name="startLocation" class="form-control" value="${route.StartLocation}" required>
            </div>
            <div class="form-group">
                <label for="endLocation">End Location:</label>
                <input type="text" id="endLocation" name="endLocation" class="form-control" value="${route.EndLocation}" required>
            </div>
            <div class="form-group">
                <label for="destination">Destination:</label>
                <input type="text" id="destination" name="destination" class="form-control" value="${route.Destination}" required>
            </div>
            <div class="form-group">
                <label for="duration">Duration:</label>
                <input type="text" id="duration" name="duration" class="form-control" value="${route.Duration}" required>
            </div>
...
<form id="editForm" action="EditRoutesController" method="get">
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
            <form action="RouteDeleteController" method = "get">
