...
<div class="sidebar">
    <ul>
        ...
        <li class="submenu">
            <a href="AdminIndex.jsp" onclick="toggleSubmenu('dashboardSubmenu')">DASHBOARD</a>
        ...
        <div class="downside">
            <li><a href="${pageContext.request.contextPath}/view/Admin/AddAdmin.jsp" class="active">ADD NEW ADMIN</a></li>
