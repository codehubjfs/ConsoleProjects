...
<body>
        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <div class="row metrics">
                    ...
                    <div class="col-3">
                        <a href="assignedtaskman.jsp" style="list-style: none; text-decoration: none; color: black;">
                            <div class="metric">
                                <div class="icon"><img src="../../asserts/Image/Manager/assigned.png" alt="Assigned Task"></div>
                    ...
                    <div class="col-3">
                        <a href="completedtask.jsp" style="list-style: none; text-decoration: none; color: black;">
                            <div class="metric">
                                <div class="icon"><img src="../../asserts/Image/Manager/completed.png" alt="Completed Task"></div>
                    ...
                    <div class="col-3">
                        <a href="pendingtask.jsp" style="list-style: none; text-decoration: none; color: black;">
                            <div class="metric">
                                <div class="icon"><img src="../../asserts/Image/Manager/pending.png" alt="Pending Task"></div>
                    ...
                    <div class="col-3">
                        <a href="taskoverlayed.jsp" style="list-style: none; text-decoration: none; color: black;">
                            <div class="metric">
                                <div class="icon"><img src="../../asserts/Image/Manager/overlayed.png" alt="Overlayed Task"></div>
    ...
    <script src="../../asserts/Javascript/Manager/dashBoard.js"></script>
</body>
</html>
