...
<head>
    ...
    <link rel="stylesheet" href="../../asserts/CSS/Manager/assignedtaskman.css">
        ...
        <div class="row">
            <nav id="sidebar" class="col-md-2 d-none d-md-block sidebar">
                <div class="sidebar-sticky">
                    <h5 class="sidebar-heading">Manager's Dashboard</h5>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" class="edit-task" data-toggle="modal" data-target="#editTask">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><strong>Description: </strong>Wanted to create an detialed page for food</p>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="TaskId" id="taskid" disabled value="1">
                    </div>
                    <div class="form-group">
                        <label for="TaskDes">Task Description: </label><br>
                        <textarea name="TaskDes" id="taskdes" disabled>Wanted To create an JavaScript file</textarea>
                    </div>
                    <div class="form-group">
                        <label for="Due">Due Date: </label>
                        <input type="text" name="Due" id="duedate" disabled value="12/05/2024">
                    </div>
                    <div class="form-group">
                        <label for="taskPriority">Priority</label>
                        <select class="form-control" id="taskPriority">
