...
/**
 * Servlet implementation class MUpdateOverlayed
 */
public class MUpdateOverlayed extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MUpdateOverlayed() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("MOverlayedTask").forward(request, response);
	}
