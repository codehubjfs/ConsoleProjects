...
/**
 * Servlet implementation class MUpdateTaskController
 */
public class MUpdateTaskControllerPending extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MUpdateTaskControllerPending() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("MPendingTask").forward(request, response);
	}
