...
/**
 * Servlet implementation class UpdateOverlayed
 */
public class UpdateOverlayed extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateOverlayed() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("OverlayedTask").forward(request, response);
	}
