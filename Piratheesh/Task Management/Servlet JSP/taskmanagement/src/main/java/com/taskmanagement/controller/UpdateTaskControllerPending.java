...
/**
 * Servlet implementation class UpdateTaskControllerPending
 */
public class UpdateTaskControllerPending extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateTaskControllerPending() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("PendingTask").forward(request, response);
	}
