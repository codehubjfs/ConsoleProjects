...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/asserts/CSS/Manager/dashBoard.css">
...
<body>
        ...
        <div class="row">
            <nav id="sidebar" class="col-md-2 d-none d-md-block sidebar">
                <div class="sidebar-sticky">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active" href="${pageContext.request.contextPath}/MangerDashBoard">Dashboard</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="${pageContext.request.contextPath}/views/Manager/team.jsp">View Team</a>
                        </li>
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/TaskManage" class="nav-link">Task Management</a>
                        </li>
                        <li class="nav-item">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <div class="row metrics">
                    ...
                    <div class="col-3">
                        <a href="${pageContext.request.contextPath}/MAssignedTask" style="list-style: none; text-decoration: none; color: black;">
                            <div class="metric">
                                <div class="icon"><img src="${pageContext.request.contextPath}/asserts/Image/Manager/assigned.png" alt="Assigned Task"></div>
                    ...
                    <div class="col-3">
                        <a href="${pageContext.request.contextPath}/MCompletedTask" style="list-style: none; text-decoration: none; color: black;">
                            <div class="metric">
                                <div class="icon"><img src="${pageContext.request.contextPath}/asserts/Image/Manager/completed.png" alt="Completed Task"></div>
                    ...
                    <div class="col-3">
                        <a href="${pageContext.request.contextPath}/MPendingTask" style="list-style: none; text-decoration: none; color: black;">
                            <div class="metric">
                                <div class="icon"><img src="${pageContext.request.contextPath}/asserts/Image/Manager/pending.png" alt="Pending Task"></div>
                    ...
                    <div class="col-3">
                        <a href="${pageContext.request.contextPath}/MOverlayedTask" style="list-style: none; text-decoration: none; color: black;">
                            <div class="metric">
                                <div class="icon"><img src="${pageContext.request.contextPath}/asserts/Image/Manager/overlayed.png" alt="Overlayed Task"></div>
    ...
    <script src="${pageContext.request.contextPath}/asserts/Javascript/Manager/dashBoard.js""></script>
</body>
</html>
