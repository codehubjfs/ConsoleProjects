    ...
    <div class="container-fluid" style="margin: 0% !important; padding:0% !important">
        ...
        <div class="row">
            <nav id="sidebar" class="col-md-2 d-none d-md-block sidebar">
                <div class="sidebar-sticky">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/PendingTask" class="nav-link active">Pending Task</a>
                        </li>
                        <li class="nav-item">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <h1 class="h2" style="text-align: center;">Pending Task</h1>
                <hr>
                <table class="table table-striped table-bordered">
                    ...
                    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
                        <c:forEach var="task" items="${pendingTasks}" varStatus="status">
                        <tr>
                        	<td>${status.count}</td>
                            <td>${task.task_id}</td>
    ...
    <div class="modal fade" id="editTaskModal" tabindex="-1" role="dialog" aria-labelledby="editTaskModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="UpdateTaskControllerPending" method="post">
                    
                        <div class="form-group">
                            <label for="attachment">Serial Number</label>
     ...
     <script>
        $(document).ready(function () {
            $('.edit-task').on('click', function () {
                ...
                var dueDate = row.find('td:eq(3)').text();
