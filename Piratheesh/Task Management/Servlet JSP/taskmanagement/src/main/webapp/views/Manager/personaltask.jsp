            ...
            <nav class="col-md-2 d-none d-md-block sidebar">
                <div class="sidebar-sticky">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/MPersonalTask" class="nav-link active">Personal Task Management</a>
                        </li>
                        <li class="nav-item">
											        ...
											        <c:forEach var="task" items="${personalTasks}">
											            <tr>
											                ...
											                <td>
											                    ...
											                    <a href="#" class="delete-task" data-toggle="modal" data-target="#deleteTaskModal" data-task-id="${task.task_id}"><i class="fa fa-trash" style="text-align: center;"></i></a>
											                </td>
											            </tr>
											        </c:forEach>
											    </tbody>
...
<div class="modal fade" id="addTaskModal" tabindex="-1" aria-labelledby="addTaskModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="taskForm" action="MPersonalTaskAdd" method="post" novalidate>
...
<div class="modal fade" id="editTaskModal" tabindex="-1" aria-labelledby="editTaskModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="editTaskForm" action="MEditPersonalTask" method="post" novalidate>
                <div class="modal-header">
...
<div class="modal fade" id="deleteTaskModal" tabindex="-1" aria-labelledby="deleteTaskModalLabel" aria-hidden="true">
    ...
    <script src="${pageContext.request.contextPath}/asserts/Javascript/Manager/personaltask.js">
   ...
   $('#confirmDelete').on('click', function () {
       var taskId = $(this).data('task-id');
       window.location.href = 'MDeleteTaskPerosnal?taskId=' + encodeURIComponent(taskId);
   });
