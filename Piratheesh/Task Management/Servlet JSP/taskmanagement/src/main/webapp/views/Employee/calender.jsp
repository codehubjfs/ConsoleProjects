...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/asserts/CSS/Employee/calender.css">
            ...
            <nav class="col-md-2 d-none d-md-block sidebar">
                <div class="sidebar-sticky">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/views/Employee/calender.jsp" class="nav-link active">Calendar</a>
                        </li>
                        <li class="nav-item">
