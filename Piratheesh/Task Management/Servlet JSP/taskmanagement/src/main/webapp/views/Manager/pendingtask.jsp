            ...
            <nav id="sidebar" class="col-md-2 d-none d-md-block sidebar">
                <div class="sidebar-sticky">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="${pageContext.request.contextPath}/ManagerDashBoard">Dashboard</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/MPendingTask" class="nav-link active">Pending Task</a>
                        </li>
                        <li class="nav-item">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
                        ...
                        <tr>
                            ...
                            <td>${task.status}</td>
                            <td>
                                <a href="#" class="info-task" data-toggle="modal" data-target="#aboutTask" data-target="#aboutTask" data-description="${task.desp}" data-priority="${task.priority}">
    ...
    <div class="modal fade" id="editTaskModal" tabindex="-1" role="dialog" aria-labelledby="editTaskModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="MUpdateTaskControllerPending" method="post">
