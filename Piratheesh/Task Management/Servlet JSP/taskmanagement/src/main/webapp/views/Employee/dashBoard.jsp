...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/asserts/CSS/Employee/dashBoard.css">
...
<body>
        ...
        <div class="row">
            <nav id="sidebar" class="col-md-2 d-none d-md-block sidebar">
                <div class="sidebar-sticky">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active" href="${pageContext.request.contextPath}/EmployeeDashBoard">Dashboard</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/PersonalTask" class="nav-link">Personal Task Management</a>
                        </li>
                        <li class="nav-item">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <div class="row metrics">
                    ...
                    <div class="col-3">
                        <a href="${pageContext.request.contextPath}/AssignedTask" style="list-style: none; text-decoration: none; color: black;">
                            <div class="metric">
                                <div class="icon"><img src="${pageContext.request.contextPath}/asserts/Image/Employee/assigned.png" alt="Assigned Task"></div>
                    ...
                    <div class="col-3">
                        <a href="${pageContext.request.contextPath}/CompletedTask" style="list-style: none; text-decoration: none; color: black;">
                            <div class="metric">
                                <div class="icon"><img src="${pageContext.request.contextPath}/asserts/Image/Employee/completed.png" alt="Completed Task"></div>
                    ...
                    <div class="col-3">
                        <a href="${pageContext.request.contextPath}/PendingTask" style="list-style: none; text-decoration: none; color: black;">
                            <div class="metric">
                                <div class="icon"><img src="${pageContext.request.contextPath}/asserts/Image/Employee/pending.png" alt="Pending Task"></div>
                    ...
                    <div class="col-3">
                        <a href="${pageContext.request.contextPath}/OverlayedTask" style="list-style: none; text-decoration: none; color: black;">
                            <div class="metric">
                                <div class="icon"><img src="${pageContext.request.contextPath}/asserts/Image/Employee/overlayed.png" alt="Overlayed Task"></div>
                                                    ...
                                                    <table class="table table-hover">
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          <td>101</td>
                                                          <td>BackEnd</td>
                                                          <td>Create an DB connection for Project</td>
                                                        ...
                                                        <tr>
                                                          <td>401</td>
                                                          <td>Front End</td>
                                                          <td>Wanted To create an login page</td>
                                                        ...
                                                        <tr>
                                                          <td>502</td>
                                                          <td>Servlet</td>
                                                          <td>Connect the Main page of the project</td>
    ...
    <script src="${pageContext.request.contextPath}/asserts/Javascript/Employee/dashBoard.js"></script>
</body>
</html>
