        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Good Morning, Admin</h1>
                </div>
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Good Morning, Admin</h1>
                </div>
                <div class="row metrics">
                    <div class="col-3">
                        <a href="#"></a>
                        <div class="metric">
                            <div class="icon"><img src="../../asserts/Image/Admin/employee.png" alt="Total Supervisors"></div>
                            <div class="value">10</div>
                            <div class="label">Total Employee's Registred</div>
                        </div>
                    </div>
                    <div class="col-3">
                        <a href="#"></a>
                        <div class="metric">
                            <div class="icon"><img src="../../asserts/Image/Admin/employeenot.png" alt="Total Wardens"></div>
                            <div class="value">15</div>
                            <div class="label">Total Employee's Not Registred</div>
                        </div>
                    </div>
                    <div class="col-3">
                        <a href="#"></a>
                        <div class="metric">
                            <div class="icon"><img src="../../asserts/Image/Admin/admin.png.png" alt="Total Students"></div>
                            <div class="value">5</div>
                            <div class="label">Total Admin Registred</div>
                        </div>
                    </div>
                    <div class="col-3">
                        <a href="#"></a>
                        <div class="metric">
                            <div class="icon"><img src="../../asserts/Image/Admin/adminnot.png" alt="Total Issues"></div>
                            <div class="value">2</div>
                            <div class="label">Total Admin Not Registred</div>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-md-3 content mb-3">
                        <div class="card h-100">
                            <img src="../../asserts/Image/Admin/employeemanage.png" class="card-img-top" alt="Feature 1">
                            <div class="card-body text-center">
                                <h5 class="card-title">Employee Management</h5>
                                <p class="card-text">Manage all Employee ,Managers and their activities.</p>
                                <a href="employeemanage.jsp" class="btn btn-primary">Manage Employee</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 content mb-3">
                        <div class="card h-100">
                            <img src="../../asserts/Image/Admin/adminmanage.png" class="card-img-top" alt="Feature 1">
                            <div class="card-body text-center">
                                <h5 class="card-title">Admin Management</h5>
                                <p class="card-text">Manage all Admin and their activities.</p>
                                <a href="adminmanage.jsp" class="btn btn-primary">Manage Admin</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 content mb-3">
                        <div class="card h-100">
                            <img src="../../asserts/Image/Admin/reports.png" class="card-img-top" alt="Feature 1">
                            <div class="card-body text-center">
                                <h5 class="card-title">Report Management</h5>
                                <p class="card-text">Manage all Report , their outcomes, and their activities.</p>
                                <a href="reportmanage.jsp" class="btn btn-primary">Manage Report</a>
                            </div>
                        </div>
                    </div>
                </div>
