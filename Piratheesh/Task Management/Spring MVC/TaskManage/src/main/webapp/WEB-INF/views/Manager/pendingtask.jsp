    ...
    <div class="container-fluid" style="margin: 0% !important; padding:0% !important">
        ...
        <div class="row">
            <nav id="sidebar" class="col-md-2 d-none d-md-block sidebar">
                <div class="sidebar-sticky">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/manager/pending" class="nav-link active">Pending Task</a>
                        </li>
                        <li class="nav-item">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-5">
                ...
                <hr>
                <table class="table table-striped table-bordered" id="pendingTask">
                    ...
                    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
                        ...
                        <tr>
                            ...
                            <td>${task.status}</td>
                            <td>
                                <a href="#" class="info-task" data-toggle="modal" data-target="#aboutTask" data-target="#aboutTask" data-description="${task.task_desp}" data-priority="${task.task_priortiy}">
    ...
    <div class="modal fade" id="editTaskModal" tabindex="-1" role="dialog" aria-labelledby="editTaskModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="${pageContext.request.contextPath}/manager/updatependingtask" method="post">
