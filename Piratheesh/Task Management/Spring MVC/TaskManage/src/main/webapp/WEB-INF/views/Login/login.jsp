...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets/CSS/Home/login.css">
    <script>
        ...
        <div class="row justify-content-center mb-5">
            ...
            <h1 style='padding-left:5px; color:#0B0B21;'>Task Management System</h1>
                <div class="text-center">
                    <img src="assets/Image/Manager/taskmanagement1.jpg" style="height: 50px; width: 50px;" class="rounded mb-3" alt="Logo">
                </div>
