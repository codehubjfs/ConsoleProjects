    ...
    <div class="container-fluid" style="margin: 0% !important; padding:0% !important">
        ...
        <div class="row">
            <nav class="col-md-2 d-none d-md-block sidebar">
                <div class="sidebar-sticky">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/manager/personaltask" class="nav-link active">Personal Task Management</a>
                        </li>
                        <li class="nav-item">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-5">
                ...
                <div><h1 style="text-align: center;">Perosnal Task Creation</h1></div>
                <hr>
...
<div class="modal fade" id="addTaskModal" tabindex="-1" aria-labelledby="addTaskModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="taskForm" action="${pageContext.request.contextPath}/manager/personalTaskAdd" method="post" novalidate>
...
<div class="modal fade" id="editTaskModal" tabindex="-1" aria-labelledby="editTaskModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="editTaskForm" action="${pageContext.request.contextPath}/manager/personalTaskEdit" method="post" novalidate>
                <div class="modal-header">
...
<div class="modal fade" id="deleteTaskModal" tabindex="-1" aria-labelledby="deleteTaskModalLabel" aria-hidden="true">
   ...
   $('#confirmDelete').on('click', function () {
       var taskId = $(this).data('task-id');
       location.href = '${pageContext.request.contextPath}/manager/deletePersonalTask?taskId=' + encodeURIComponent(taskId);
   });
    });
