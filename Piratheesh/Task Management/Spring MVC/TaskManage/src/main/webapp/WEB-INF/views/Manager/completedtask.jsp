    ...
    <div class="container-fluid" style="margin: 0% !important; padding:0% !important">
        ...
        <div class="row">
            <nav id="sidebar" class="col-md-2 d-none d-md-block sidebar">
                <div class="sidebar-sticky">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/manager/calender.jsp" class="nav-link">Calendar</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/manager/completed" class="nav-link active">Completed Task</a>
                        </li>
                        <li class="nav-item">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-5">
                ...
                <hr>
                <table class="table table-striped table-bordered" id="completedTask">
            ...
            <tr>
                ...
                <td>
                    <a href="#" class="info-task" data-toggle="modal" data-target="#aboutTask" 
                       data-description="${task.task_desp}" data-priority="${task.task_priortiy}">
