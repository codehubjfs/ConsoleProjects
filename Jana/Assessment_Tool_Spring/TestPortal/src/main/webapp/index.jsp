        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-2 d-flex justify-content-start">
                    <img src="${pageContext.request.contextPath}/Asserts/Images/new-logo.png" class="rounded mx-2" id="logo" alt="Logo">
                </div>
                <div class="col-8 text-center">
                    <h1 class="mb-0">ASSESSMENT HUB</h1>
                </div>
                <div class="col-2 d-flex justify-content-end">
                    <a href="${pageContext.request.contextPath}/loginPage" class="text-decoration-none">
