        ...
        <div class="col-11 offset-1">
            ...
            <div class="row">
                <c:forEach var="course" items="${courses}">
                    <div class="col-md-4">
                      <a href="${pageContext.request.contextPath}/student/assessments?courseId=${course.cid}&courseName=${fn:escapeXml(course.cname)}" style="text-decoration: none;">  
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center mb-4">
                    <img src="https://img.freepik.com/premium-vector/student-vector-illustration-cartoon_969863-914.jpg" class="rounded-circle" alt="Profile Avatar" id="profile-img">
                </div>
                <form>
                    <div class="form-group">
                        <label for="sid">Student ID</label>
                        <input type="text" class="form-control" id="sid" value="${student.sid}" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="password" value="${student.password}" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="gender" value="${student.gender}">
                    </div>
                    <div class="form-group">
                        <label for="city">City</label>
                        <input type="text" class="form-control" id="city" value="${student.city}">
                    </div>
                    <div class="form-group">
                        <label for="country">Country</label>
                        <input type="text" class="form-control" id="country" value="${student.country}">
                    </div>
                    <button type="button" class="btn btn-link" id="changePassword">Change Password</button>
                </form>
            </div>
