    ...
    document.addEventListener('visibilitychange', function () {
        if (document.hidden) {
            ...
            if (tabSwitchCount === 3) {
                ...
                $('#tabAlertText').text(`You have switched tabs ${tabSwitchCount} time(s). On the third switch, the test will be submitted.`);
                $('#tabAlertModal').modal('show');
            }
        }
    });
}
