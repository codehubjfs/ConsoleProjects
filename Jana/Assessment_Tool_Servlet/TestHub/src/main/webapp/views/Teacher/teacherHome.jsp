        ...
        <div class="col-11 offset-1">
            ...
            <div class="row">
                <c:forEach var="course" items="${courses}">
                    <div class="col-md-4">
                        <a href="${pageContext.request.contextPath}/TeacherAssessmentServlet?courseId=${course.courseId}&courseName=${fn:escapeXml(course.courseName)}" style="text-decoration: none;">
