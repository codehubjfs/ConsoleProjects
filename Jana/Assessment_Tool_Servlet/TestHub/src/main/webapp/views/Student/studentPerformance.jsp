...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/Styles/performance.css">
...
<script src="${pageContext.request.contextPath}/resources/Scripts/performance.js"></script>
</body>
</html>
