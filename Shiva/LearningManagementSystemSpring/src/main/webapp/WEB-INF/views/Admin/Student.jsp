...
<main role="main" class="main-content container-fluid mt-5 ml-5">
    <div class="container mt-5">
        <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#addModal">Add Student</button>
        <table class="table table-bordered text-center" id="instructorsTable">
            ...
            <tbody id="instructorsTableBody">
                ...
                <tr>
                    ...
                    <td><%= s.getPassword() %></td>
                    <td>
                        <img src="asserts/images/pencil-square.svg" alt="Edit" class="action-icon edit-icon pr-1 edit-student" data-toggle="modal" data-target="#editModal" data-student-id="<%= s.getStudentId() %>" onclick="populateEditModal(this)">
						<a href="#" ><img src="asserts/images/trash3-fill.svg" id="triggerModalBtn" data-toggle="modal" data-student-id="<%= s.getStudentId() %>" data-target="#confirmModal"></a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addForm" action="addStudent" >
    ...
    <div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="confirmModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="confirmModalLabel">Delete Student</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editForm" action="editStudent" >
    <div class="form-group">
    ...
    <input type="number" id="editStudentId" name="studentId" hidden> <!-- Hidden input for studentId -->
...
$('#confirmModal').on('show.bs.modal', function (event) {
        ...
        deleteLink.attr('href', 'DeleteStudent?studentId=' + studentId);
    });
