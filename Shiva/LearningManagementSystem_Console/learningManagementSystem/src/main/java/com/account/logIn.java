	...
	public static void main(String[] args) {
		...
		try
		{
			...
			case 2:
			{
				...
				ResultSet r=st.executeQuery("select * from instructor where username='"+userName+"' and password='"+password+"'");
				if(!r.isBeforeFirst())
				{
					System.out.println("Username or password incorrect");
					break;
				...
				while(r.next())
				{
					instructor=new Instructor(r.getInt("instructorid"),r.getString("firstname"),r.getString("lastname"),r.getString("department"),r.getString("username"),r.getString("password"),r.getString("email"),r.getInt("courseid"));
				...
				instructorObject.instructorChoices(st,instructor);
