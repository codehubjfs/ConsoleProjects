...
public class Courses implements Comparable<Courses>{
	...
	private ArrayList<Instructor>intstructorList=new ArrayList<Instructor>();
	...
	public ArrayList<Instructor> getIntstructorList() {
		return intstructorList;
	}

	public void setIntstructorList(ArrayList<Instructor> intstructorList) {
		this.intstructorList = intstructorList;
	}
