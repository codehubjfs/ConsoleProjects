...
<head>
  ...
  <!-- Custom CSS -->
  <link rel="stylesheet" href="${pageContext.request.contextPath}/asserts/css/user/register.css">
</head>
<body>
        ...
        <div class="card-body">
          ...
          <form id="registrationForm" action="register" method="post" onsubmit="return validateForm()">
            ...
            <div class="text-center mt-3">
              <a href="connect">Already have an account? Login</a>
            </div>
          </form>
...
function validateField(fieldName) {
  ...
  switch (fieldName) {
    ...
    case 'age':
      if (fieldValue === '') {
        errorMessage = 'Age cannot be empty.';
    	  ...
    	  {
    	  errorMessage = 'Age Should not be 0';
    	  }
    ...
    var confirmPasswordValue = document.getElementById('confirmPassword').value.trim();
      ...
      else if (confirmPasswordValue !== '' && fieldValue !== confirmPasswordValue) {
