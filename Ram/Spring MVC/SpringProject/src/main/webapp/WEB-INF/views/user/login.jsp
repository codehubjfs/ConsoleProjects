...
<!-- Custom CSS -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/asserts/css/user/login.css">
</head>
<body>
    <!-- Navbar -->
    ...
    <i class="fas fa-arrow-left"></i> Home
                        ...
                        <form id="loginForm" action="log" >
                         ...
                         <a href="reg" class="btn btn-secondary btn-sm btn-block mt-2 pt-2 pb-2">Register</a>
