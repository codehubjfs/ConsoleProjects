...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/asserts/css/user/about.css">
</head>
<style>
.nav-link.active {
        ...
        <section class="about-us py-5">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <img src="${pageContext.request.contextPath}/asserts/images/rep.jpg" alt="About Us Image" class="img-fluid">
                    </div>
                </div>
            </div>
        </section>
