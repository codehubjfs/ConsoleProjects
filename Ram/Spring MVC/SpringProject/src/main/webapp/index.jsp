...
<html lang="en">
  <head>
    ...
    />
    <link rel="stylesheet" href="${pageContext.request.contextPath}/asserts/css/user/main.css">
 ...
 .hero {
        ...
        .hero {
            background-image: url(asserts/images/cityhotel.jpg);
        ...
        .info, .rooms, .restaurant, .spa, .testimonials {
            padding: 4rem 0;
        }
        .info {
        ...
        .rooms .headline, .restaurant h2, .spa h2, .testimonials h2 {
            color: #00264d;
        }
        .btn-success {
            background-color: #ffcc00;
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            %>
              <li class="nav-item">
                <a class="nav-link btn btn-light text-white mr-2" href="vr">
        ...
        <div class="row">
          <div class="col-md-6 d-flex flex-column justify-content-center">
            <div class="info-box mb-4">
              ...
              <p class="info-text">Welcome to Rk Hotel, where luxury meets comfort. Enjoy unparalleled hospitality, top-notch amenities, and a memorable stay that will exceed your expectations.</p>
            </div>
            <div class="info-box mb-4">
              <i class="fas fa-briefcase fa-2x mb-2"></i>
              <p class="info-text">Whether you're here for business or leisure, our hotel offers the perfect blend of convenience and elegance, making every moment special.</p>
            </div>
            <div class="info-box mb-4">
              <i class="fas fa-concierge-bell fa-2x mb-2"></i>
              <p class="info-text">Our dedicated staff is always ready to assist you, ensuring your stay is as comfortable and enjoyable as possible.</p>
            </div>
            <div class="info-box mb-4">
              <i class="fas fa-map-marker-alt fa-2x mb-2"></i>
              <p class="info-text">Located in the heart of the city, Rk Hotel provides easy access to major attractions, shopping centers, and business hubs.</p>
            </div>
          </div>
          <div class="col-md-6 d-flex flex-column">
            <img src="${pageContext.request.contextPath}/asserts/images/double2.jpg" alt="image" class="img-fluid mb-3" />
            <img src="${pageContext.request.contextPath}/asserts/images/s3.jpg" alt="image" class="img-fluid" />
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
            ...
            <div id="roomsCarousel" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="${pageContext.request.contextPath}/asserts/images/r3.jpg" class="d-block w-100" alt="Room Image 1" />
                </div>
                <div class="carousel-item">
                  <img src="${pageContext.request.contextPath}/asserts/images/room1.jpg" class="d-block w-100" alt="Room Image 2" />
                </div>
                <div class="carousel-item">
                  <img src="${pageContext.request.contextPath}/asserts/images/r2.jpg" class="d-block w-100" alt="Room Image 3" />
                </div>
              </div>
          ...
          <div class="col-md-6 d-flex flex-column justify-content-center">
            ...
            <p><i class="fas fa-bed"></i> Our rooms are designed to provide you with the utmost comfort and luxury. Each room features modern decor, comfortable bedding, and all the amenities you need for a relaxing stay.</p>
            <p><i class="fas fa-tv"></i> Enjoy complimentary high-speed internet, flat-screen TVs, and stunning views from your window. Experience the perfect blend of elegance and convenience in every room.</p>
            <button class="btn btn-success mt-3" onclick="location.href='vr'">Explore Now</button>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-md-3">
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-text">Relax and rejuvenate at our luxurious spa.</p>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <blockquote class="blockquote">
                <p class="mb-0">"The service at Rk Hotel is exceptional. The staff goes above and beyond to make your stay comfortable. Highly recommend!"</p>
                <footer class="blockquote-footer">John Doe, CEO of Acme Corp</footer>
              </blockquote>
            </div>
            <div class="carousel-item">
              <blockquote class="blockquote">
                <p class="mb-0">"A wonderful experience from start to finish. The rooms are luxurious and the amenities are top-notch. I will definitely be back!"</p>
                <footer class="blockquote-footer">Jane Smith, Travel Blogger</footer>
              </blockquote>
            </div>
