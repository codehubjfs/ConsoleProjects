...
<header>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="try.html">Rk Hotel</a>
    ...
    <div id="hero" class="hero d-flex justify-content-center align-items-center">
        <div class="container text-center text-white">
            ...
            <button class="btn " onclick="location.href='${pageContext.request.contextPath}/CommonRoomServlet'">Book a Room</button>
        </div>
    </div>
</header>
