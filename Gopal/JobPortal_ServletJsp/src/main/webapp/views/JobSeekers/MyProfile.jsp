        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav_list">
                    ...
                    <a href="${pageContext.request.contextPath}/JobSeekerProfileRetriveController" class="nav_link active">
                ...
                <div class="profile-details">
                    ...
                    <div class="profile-info">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="name" class="form-control" value="${seeker.name}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="dob" class="form-label">Date of Birth:</label>
                            <input type="text" id="dob" class="form-control" value="${seeker.dob}" readonly>
                        </div>
                         <div class="mb-3">
                            <label for="district" class="form-label">Email:</label>
                            <input type="text" id="district" class="form-control" value="${seeker.email}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="district" class="form-label">Phone:</label>
                            <input type="text" id="district" class="form-control" value="${seeker.phone}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="district" class="form-label">Address:</label>
                            <input type="text" id="district" class="form-control" value="${seeker.address}" readonly>
                        </div>
                      
                        <div class="mb-3">
                            <label for="gender" class="form-label">Gender:</label>
                            <input type="text" id="gender" class="form-control" value="${seeker.gender}" readonly>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-8">
                ...
                <div class="profile-details">
                    <div class="profile-info">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="course1" class="form-control" value="${seeker.course}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="specialization1" class="form-label">Specialization:</label>
                            <input type="text" id="specialization1" class="form-control" value="${seeker.specialization}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="passingYear1" class="form-label">Passing Year:</label>
                            <input type="text" id="passingYear1" class="form-control" value="${seeker.passingYear}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="institute1" class="form-label">Institute Name:</label>
                            <input type="text" id="institute1" class="form-control" value="${seeker.institute}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="cgpa1" class="form-label">CGPA:</label>
                            <input type="text" id="cgpa1" class="form-control" value="${seeker.cgpa}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="courseType1" class="form-label">Course Type:</label>
                            <input type="text" id="courseType1" class="form-control" value="${seeker.courseType}" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="profile-details">
                    <div class="profile-info">
                        <h2>Experience</h2>
                        <div class="mb-3">
                            <label for="yearsExperience1" class="form-label">Company Name:</label>
                            <input type="text" id="yearsExperience1" class="form-control" value="${seeker.companyName}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="yearsExperience1" class="form-label">Years of Experience:</label>
                            <input type="text" id="yearsExperience1" class="form-control" value="${seeker.yearsExperience}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="designation1" class="form-label">Designation:</label>
                            <input type="text" id="designation1" class="form-control" value="${seeker.designation}" readonly>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="profile-info">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="textarea" rows="5" cols="30" minlength="10" maxlength="20" id="language1" class="form-control"  readonly>"${seeker.objective}"</textarea>
                        </div>
