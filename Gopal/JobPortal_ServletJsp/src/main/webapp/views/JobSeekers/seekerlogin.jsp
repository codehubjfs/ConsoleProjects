...
<body>
      ...
      <ul class="navbar-nav h6">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="loginDropdown">
            ...
            <a class="dropdown-item hi" href="#">Job Seekers</a>
  ...
  <div class="login-container">
    <div class="login-box">
      ...
      <form id="loginForm" action="..\..\SeekerLogin" method="post">
        ...
        <div class="sub">
          ...
          <a href="ForgetPassword.jsp" class="forget"><i class="fas fa-unlock-alt"></i>Forgot Password?</a>
        </div>
      </form>
    </div>
  </div>
