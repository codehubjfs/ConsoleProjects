...
<body>
    ...
    <div class="card">
        ...
        <form name="forgotPasswordForm" action="${pageContext.request.contextPath}/SeerkerPasswordForget" method="post" onsubmit="return validateForm()">
            <div class="form-group">
                <input type="email" class="form-control" name="email" placeholder="Enter your email" oninput="validateForm()" required>
                <div id="emailFeedback" class="feedback"></div>
            </div>
            <button type="submit" class="btn btn-primary btn-lg btn-submit">Submit</button>
        </form>
        
        <a href="views/JobSeekers/seekerlogin.jsp" class="btn btn-secondary btn-back">Back to Login</a>
