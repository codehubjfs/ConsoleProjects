...
<body id="body-pd">
        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav_list">
                    ...
                    <a href="${pageContext.request.contextPath}/AdminRetriveData" class="nav_link active" id="job-link">
    ...
    <div class="form-inline justify-content-between mt-6 border border-secondary bg-secondary">
        ...
        <button class="btn btn-primary ml-2" id="exportPDF">Export as PDF</button>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-info btn-sm btn-view" data-toggle="tooltip" title="View"
                                data-name="${jobSeeker.name}" data-phone="${jobSeeker.phone}"  data-course="${jobSeeker.course}"  
                                data-email="${jobSeeker.email}" data-status="${jobSeeker.status}"  data-gender="${jobSeeker.gender}" data-cgpa="${jobSeeker.cgpa}" data-objective="${jobSeeker.objective}" data-status="${jobSeeker.status}" data-experience="${jobSeeker.yearsExperience}" data-skills="${jobSeeker.technicalSkills}">
                            <i class="fas fa-eye"></i>
                        </button>
                        <button class="btn btn-primary btn-sm btn-edit" data-toggle="tooltip" title="Edit"
                                data-name="${jobSeeker.name}" data-phone="${jobSeeker.phone}"
  ...
  <ul class="pagination">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editEmployerForm" action="${pageContext.request.contextPath}/AdminJobSeekerEditController" method="post">
