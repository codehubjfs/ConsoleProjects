...
<body>
    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="../../assets/images/side2.jpg" class="d-block w-100" alt="First slide">
            </div>
            <div class="carousel-item">
                <img src="../../assets/images/side3.jpg" class="d-block w-100" alt="Second slide">
            </div>
            <div class="carousel-item">
                <img src="../../assets/images/side4.jpg" class="d-block w-100" alt="Third slide">
            </div>
        </div>
    ...
    <div class="iconsectors">
        ...
        <div class="icons">
            <img src="../../assets/images/icons/sector.png" alt="">
        ...
        <div class="icons">
            <img src="../../assets/images/icons/placed.png" alt="">
            <h4 class="value">3216</h4>
            <h5>Placement Offer</h5>
        </div>
        <div class="icons">
            <img src="../../assets/images/icons/offers.png" alt="">
...
<div class="">
   ...
   <div class="slide">
    <div class="slideicon">
        <img src="../../assets/images/icons/work-from-home_8332554.png" alt="">
        <!-- <h5 class="value">Design & Creative</h5> -->
        <h5>Information Technology</h5>
    </div>
    <div class="slideicon">
        <img src="../../assets/images/icons/property_9202660.png" alt="">
        <!-- <h5 class="value">Design & Creative</h5> -->
        <h5>Real Estate</h5>
    </div>
    <div class="slideicon">
        <img src="../../assets/images/icons/promotion_13079204.png" alt="">
        <!-- <h5 class="value">Design & Creative</h5> -->
        <h5>Sales & Marketing</h5>
    </div>
    <div class="slideicon">
        <img src="../../assets/images/icons/employee_538672.png" alt="">
        <!-- <h5 class="value">Design & Creative</h5> -->
        <h5>Stack Market</h5>
    </div>
    <div class="slideicon">
        <img src="../../assets/images/icons/writer_3079941.png" alt="">
        <!-- <h5 class="value">Design & Creative</h5> -->
    ...
    <div class="slideicon">
        <img src="../../assets/images/icons/pop-up_11544557.png" alt="">
        <!-- <h5 class="value">Design & Creative</h5> -->
        <h5>Insurance</h5>
    </div>
    <div class="slideicon">
        <img src="../../assets/images/icons/helmet_2823675.png" alt="">
        <!-- <h5 class="value">Design & Creative</h5> -->
        <h5>Construction</h5>
    </div>
    <div class="slideicon">
   ...
   <div class="a" style="background-color: blueviolet; width: 100%; height: 20%;">
        ...
        <footer class="footer">
            ...
            <div class="ico">
                <img src="../../assets/images/icons/logo2_footer.png" alt="">
            </div>
