...
/**
 * Servlet implementation class AdminJobSeekerEditController
 */
public class AdminJobSeekerEditController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminJobSeekerEditController() {
        super();
