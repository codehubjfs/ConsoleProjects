    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div>
                ...
                <div class="nav_list">
                    <a href="cart" class="nav_link active">
...
$(document).ready(function() {
    ...
    const jobApplicationSize = ${jobApplicationSize};

    // Example dynamic data for charts (replace with real data if available)
    const jobSeekersData = [5, 10, 11, 18, 19, 25, seekerSize];
    const employersData = [3, 3, 4, 6, 8, 10, employe];
    const applicationsData = [0, 0, 1, 2, 2, 2, jobApplicationSize];

    // Set dynamic values in the HTML
    $('#seekerSize').text(seekerSize);
    $('#employe').text(employe);
    $('#jobSize').text(jobSize);
    $('#jobApplicationSize').text(jobApplicationSize);
