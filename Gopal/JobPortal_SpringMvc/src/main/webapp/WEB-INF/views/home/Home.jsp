...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<a class="navbar-brand" href="#"><img
			src="../../assets/images/head.2.png" alt="Jobportal"></a>
		...
		<div class="collapse navbar-collapse justify-content-center"
			...
			<ul class="h6 navbar-nav">
				<li class="nav-item"><a class="nav-link hi" href="home.jsp">Home
						<span class="sr-only">(current)</span>
				</a></li>
				<li class="nav-item"><a class="nav-link" href="job.jsp">Jobs</a>
				</li>
				...
				<li class="nav-item dropdown"><a class="nav-link " href="#"
					...
					<div class="dropdown-menu" aria-labelledby="loginDropdown">
						...
						<a class="dropdown-item" href="..\JobSeekers\seekerlogin.jsp">Job
							Seekers</a> <a class="dropdown-item" href="..\Admin\AdminLogin.jsp">Admin</a>
					</div></li>
			</ul>
		</div>
	</nav>
	<div id="carouselExampleControls" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="../../assets/images/side2.jpg" class="d-block w-100"
					alt="First slide">
			</div>
			<div class="carousel-item">
				<img src="../../assets/images/side3.jpg" class="d-block w-100"
					alt="Second slide">
			</div>
			<div class="carousel-item">
				<img src="../../assets/images/side4.jpg" class="d-block w-100"
					alt="Third slide">
			</div>
		</div>
	...
	<div class="">
		...
		<div class="slide">
			<div class="slideicon">
				<img src="../../assets/images/icons/work-from-home_8332554.png"
					alt="">
