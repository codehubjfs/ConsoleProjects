...
<body>
        ...
        <div class="row mt-4">
            <div class="col-md-4">
                <div class="card">
                   <h5 class="card-title">Car Availability</h5>
                        <form id="availabilityForm" action="${pageContext.request.contextPath}/CarAvailabilityServlet" method="post">
            ...
            <div class="col-md-8 bar1">
                <div class="card">
                    ...
                    <img src="Gemini_Chart_Image_td4owxtd4owxtd4o.png" alt="Earning Summary" class="img-fluid">
                </div>
            </div>
        </div>
        <div class="row mt-4">
            ...
            <div class="col-md-6 chart2">
                <div class="card">
                    ...
                    <img src="Gemini_Chart_Image_v7bpunv7bpunv7bp (1).png" alt="Income Analysis" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="../../javascript/adminIndex.js">
