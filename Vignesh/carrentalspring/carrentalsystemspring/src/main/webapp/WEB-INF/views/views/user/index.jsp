...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assert/css/userIndex.css">
...
<body>
    ...
    <div class="video-container">
        <video autoplay muted loop id="bgVideo">
            <source src="${pageContext.request.contextPath}/assert/images/mylivewallpapers-com-BMW-M5-F90-4K.mp4" type="video/mp4">
        </video>
        <div class="overlay">
            ...
            <button class="stylish-button" data-bs-toggle="cars.html" data-bs-target="cars.html">
              <a href="${pageContext.request.contextPath}/cars" style="text-decoration: none; color: rgb(253, 253, 253);">
                Rent Now </a>            
            </button>
        </div>
    </div>
    ...
    <section class="hero-section">
        ...
        <div class="hero-image">
            <img src="${pageContext.request.contextPath}/assert/images/aboutcar2.jpg" alt="Car Rental">
      ...
      <div class="carousel-item active">
        <div class="container">
          <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <img src="${pageContext.request.contextPath}/assert/images/bugati.jpg" class="card-img-top" alt="Car Image">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="${pageContext.request.contextPath}/assert/images/audirs.jpg" class="card-img-top" alt="Car Image">
                    <div class="price-badge">800/day</div>
                    <div class="card-body row">
      ...
      <div class="carousel-item">
        <div class="container">
          <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <img src="${pageContext.request.contextPath}/assert/images/bently.jpg" class="card-img-top" alt="Car Image">
                    <div class="price-badge">900/day</div>
                    <div class="card-body row">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6" style="text-align: center;">
                <div class="card1">
                    <img src="${pageContext.request.contextPath}/assert/images/lambo.jpg" class="card1-img-top" alt="Luxury Cars">
            ...
            <div class="col-lg-4 col-md-6" style="text-align: center;">
                <div class="card1 " style="text-align: center;">
                    <img src="${pageContext.request.contextPath}/assert/images/audirs.jpg" class="card1-img-top" alt="24/7 Support">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="review-card shadow">
                    <img src="${pageContext.request.contextPath}/assert/images/reviewer1.jpg" class="reviewer-img" alt="Reviewer 1 Image">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="review-card shadow" >
                    <img src="${pageContext.request.contextPath}/assert/images/reviwer2.jpg" class="reviewer-img" alt="Reviewer 2 Image">
                    <div class="review-content">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="review-card shadow" style="height: 100%;">
                    <img src="${pageContext.request.contextPath}/assert/images/reviewer3.jpg" class="reviewer-img" alt="Reviewer 3 Image">
                    <div class="review-content">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="stats-card shadow">
                    ...
                    <div class="stats-content">
                        <h3>Total Cars</h3>
                        <span class="stats-number"><c:out value="${totalCars}" /></span>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="stats-card shadow">
                    ...
                    <div class="stats-content">
                        ...
                        <span class="stats-number"><c:out value="${totalCustomers}" /></span>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="stats-card shadow">
                    ...
                    <div class="stats-content">
                        ...
                        <span class="stats-number"><c:out value="${totalBookings}" /></span>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <ul class="social-icons list-unstyled d-flex" >
                    <li><a href="https://www.facebook.com/login/?next=https%3A%2F%2Fwww.facebook.com%2F"><i class="fab fa-facebook-f"></i></a></li>
