...
<body>
    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        <div class="table-container" style="width:95%">
         ...
         <br>
            <table class="booking-table" style="width:100%" id="car-list">
              <thead>
            <tr>
                <th>User ID</th>
                <th>First Name</th>
              ...
              <!--   <th>Actions</th>  -->
                ...
                <tr>
                    ...
                    <td>${user.username}</td>
                     <td>
                                <button type="button" class="btn btn-warning btn-sm edit-btn" data-bs-toggle="modal" data-bs-target="#editModal" data-id="${user.user_id}">Edit</button>
                                <button type="button" class="btn btn-danger btn-sm delete-btn" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="${user.user_id}">Delete</button>
                            </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editForm" method="get" action="${pageContext.request.contextPath}/updateuser">
    <input type="hidden" name="action" value="edit">
    <input type="hidden" name="user_id" id="editBookingId">
    <div class="mb-3">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
     <form id="deleteForm" method="post" action="${pageContext.request.contextPath}/deleteuser">
