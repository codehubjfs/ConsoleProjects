...
/**
 * Servlet implementation class CustomerRegisterDataController
 */
public class CustomerMobileDataController extends HttpServlet {
     ...
     */
    public CustomerMobileDataController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// TODO Auto-generated method stub
		List<String> mobileNumbers = (List<String>) customers.stream()
