...
%>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="d-flex align-items-center justify-content-evenly vh-100">
                    <div class="invisible" id="outer-box" style="margin-left:20%" >
                        ...
                        <div class="bg-white shadow rounded">
                            <div class="row">
                               <div class="col-5 d-flex flex-column align-items-center justify-content-center bg-primary text-center text-white">
                                   <img src="${pageContext.request.contextPath}/images/admin-icon.png" height="120" width="120" class="rounded-pill img-fluid" alt=""> 
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <input name="add-admin-username" id="add-admin-username">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       		 <input type="text" class="form-control" id="add-modal-adminId">
          <div class="">
          ...
          <div class="">
            ...
            <input type="text" class="form-control" id="add-modal-password" name="edit-profile-password">
          </div> 
      </div>
      <div class="modal-footer">
