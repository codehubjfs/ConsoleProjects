            ...
            <nav class="col-md-2 col-2  sidebar position-fixed pt-0 px-0" id="sidebar">
                <div class="pt-0 px-0">
                  ...
                  <div class="nav flex-column d-flex justify-content-center" id="sidenavs">
                    ...
                    <li class="nav-item side-barnav">
                      <a class="nav-link pt-4 active" href="${pageContext.request.contextPath}/CustomerManagementController">Customer Management</a>
                    </li>
                    <li class="nav-item side-barnav">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="${pageContext.request.contextPath}/CustomerManagementDeleteController">
