        ...
        <div class="row p-2 mt-4 mb-3">
            <div class="col d-flex align-items-center">
                <div class="col-auto d-flex box-one align-items-center">
                    ...
                    <div>
                        <input class="mx-1 cart-count fw-bold" name="count" type="number" min="1" max="10" value="${orderpro.quantity}">
                    </div>
                    <div>
                ...
                <div class="card-body">
                        ...
                        <div class="form-group border-bottom py-3">
                            ...
                            <div class="collapse ml-4" id="cardDetails">
                                ...
                                <form id="paymentForm" action="${pageContext.request.contextPath}/ProductOrderPaymentController" method="post" novalidate>
    ...
    /*    document.querySelectorAll('.increment-btn').forEach(input => {
        ...
        function validateForm() {
            ...
            if (!namePattern.test(fullNameInput.value)) {
                fullNameInput.setCustomValidity('Please enter a valid full name (only alphabets and spaces, up to 50 characters).');
                isValid = false;
            } else {
            ...
            if (addressLine1Input.value.trim() === '') {
                addressLine1Input.setCustomValidity('Please enter your address.');
                isValid = false;
            } else {
                addressLine1Input.setCustomValidity('');
            }
