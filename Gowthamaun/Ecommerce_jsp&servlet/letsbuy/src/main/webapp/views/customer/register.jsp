...
<body id="reg-body">
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        <form id="registrationForm" action="${pageContext.request.contextPath}/CustomerRegisterController" method="post">
                            <div class="form-row">
                           ...
                           <div class="row">
                           	<div class="col-5">
                           		<p class="fs-5 text-secodary">Already Registered? <a href='${pageContext.request.contextPath}/views/customer/login.jsp'>Login</a></p>
                           	</div>
                            <div class="col">
    ...
    fetch('${pageContext.request.contextPath}/CustomerMobileDataController')
    ...
    fetch('${pageContext.request.contextPath}/CustomerEmailDataController')
    .then(response => response.json())
    .then(data => {
        emails = data;
    })
    ...
    fetch('${pageContext.request.contextPath}/CustomerUsernameDataController')
    .then(response => response.json())
    .then(data => {
        usernames = data;
    })
