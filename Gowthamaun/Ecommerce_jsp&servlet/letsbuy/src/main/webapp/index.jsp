            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                ...
                <ul class="navbar-nav ms-auto">
              	...
              	<li class="nav-item txt-nav">
                        <a class="nav-link" href="${pageContext.request.contextPath}/CustomerCartController">
    ...
    <div class="container-flex d-flex mx-3 mb-2 bg-white justify-content-center" id="option-menu">
        <div class="row">
            ...
            <div class="col text-center p-3">
                <a class="nav-link" href="${pageContext.request.contextPath}/MobilesPageController">
                    <div class="col">
