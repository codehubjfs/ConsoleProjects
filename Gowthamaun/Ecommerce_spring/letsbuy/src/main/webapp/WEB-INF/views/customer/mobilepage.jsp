...
<body class="bg-light">
	<div class="navbar navbar-expand-lg navbar-light bg-white shadow-sm fixed-top" id="main-navv">
        <div class="container-fluid">
            <a class="navbar-brand d-none d-md-block" href="forwardHomepage">
                <img src="${pageContext.request.contextPath}/asserts/images/logo.png" class="rounded" width="210" height="110" alt="">
            </a>
            <a class="navbar-brand d-md-none" href="forwardHomepage">
    ...
    <div class="bg-white px-2" style="margin-top:120px">
    	<nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="forwardHomepage">Home</a></li>
                <li class="breadcrumb-item"><a href="mobilePage">Mobiles</a></li>
                <li class="breadcrumb-item active" aria-current="page">MobilePage</li>
            </ol>
     </nav>
    </div>
    <div class="product-content bg-white mx-5 row pt-3" style="margin-top:50px">
        ...
        <div class="img-block col-4">
            <div class="product-outers">
                <div class="d-flex ">
                    <div class="small-imgs">
                        <div class="border text-center small-image p-2 px-3">
                            <img class="img-fluid" src="${pageContext.request.contextPath}/asserts/images/Mobiles/LargeMiImage/large-mi1.webp" alt="">
                        </div>
                        <div class="border text-center small-image  p-2 px-3">
                            <img class="img-fluid" src="${pageContext.request.contextPath}/asserts/images/Mobiles/LargeMiImage/large-mi1-1.webp" height="60" alt="">
                        </div>
                        <div class="border text-center small-image  p-2 px-3">
                            <img class="img-fluid" src="${pageContext.request.contextPath}/asserts/images/Mobiles/LargeMiImage/large-mi1-2.webp" height="60" alt="">
                        </div>
                        <div class="border text-center small-image p-2 px-3">
                            <img class="img-fluid" src="${pageContext.request.contextPath}/asserts/images/Mobiles/LargeMiImage/large-mi1-3.webp" height="60" alt="">
                        </div>
                    </div>
                    <div class="larger-img border p-5">
                        ...
                        <div class="disp-img-big">
                            <img class="img-fluid" id="showBig" src="${pageContext.request.contextPath}/asserts/images/Mobiles/LargeMiImage/large-mi1.webp" alt="">
                        </div>
                    </div>
                ...
                <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
         		...
         		<c:set var="originalPrice" value="${product.productPrice + (product.productPrice * product.discount / 100)}" />
                <div class="d-flex mt-3 down-btns justify-content-between">
                	<form action="ProductAddCartController" method="post" class="m-0">
              ...
              <%  }
                    ...
                    <form action="ProductMakeOrderController"  method="post" class="m-0">
                    <input type="hidden" name="productId" value="${product.productId}">
            ...
            <div class="product-desc-body">
                ...
                <div class="offers">
                        ...
                        <div class="offer d-flex">
                            <img src="${pageContext.request.contextPath}/asserts/images/Mobiles/offer-img.webp" alt="">
                ...
                <div class="warranty-desc d-flex ">
                    <div class="brand-product-logo ">
                        <img src="${pageContext.request.contextPath}/asserts/images/Mobiles/xiaomi.png" class="img-fluid" height="30" width="70" alt="">
                    </div>
                ...
                <div class="diff-variations px-2 mt-3">
                    <div class="row">
                        ...
                        <div class="col-auto d-flex">
                            <div class="diff-colours border d-flex justify-content-center align-items-center p-1">
                               <a href=""> <img src="${pageContext.request.contextPath}/asserts/images/Mobiles/small-img1.jpeg" class="img-fluid"></a>
                            </div>
                    ...
                    <div class="product-detail-desc mx-2 mt-4">
                        ...
                        <div class="row custom-box-border p-2 align-items-center">
                            ...
                            <div class="col">
                                <img src="${pageContext.request.contextPath}/asserts/images/Mobiles/specification/desc-battery-mi.webp" class="img-fluid" alt="">
                            </div>
                        </div>
                        <div class="row custom-box-border p-2 align-items-center">
                            <div class="col">
                                <img src="${pageContext.request.contextPath}/asserts/images/Mobiles/specification/desc-speed-mi.webp" class="img-fluid" alt="">
                            </div>
                            <div class="col-9">
                        ...
                        <div class="row custom-box-border p-2 align-items-center">
                            ...
                            <div class="col">
                                <img src="${pageContext.request.contextPath}/asserts/images/Mobiles/specification/desc-processor-mi.webp" class="img-fluid" alt="">
                            </div>
                        </div>
                        <div class="row custom-box-border p-2 align-items-center">
                            <div class="col">
                                <img src="${pageContext.request.contextPath}/asserts/images/Mobiles/specification/desc-camera-mi.webp" class="img-fluid" alt="">
                            </div>
                            <div class="col-9">
                        ...
                        <div class="row custom-box-border p-2 align-items-center">
                            ...
                            <div class="col">
                                <img src="${pageContext.request.contextPath}/asserts/images/Mobiles/specification/desc-audio-mi.webp" class="img-fluid" alt="">
                            </div>
                        </div>
                        <div class="row custom-box-border p-2 align-items-center">
                            <div class="col">
                                <img src="${pageContext.request.contextPath}/asserts/images/Mobiles/specification/desc-entertainment-mi.webp" class="img-fluid" alt="">
                            </div>
                            <div class="col-9">
                        ...
                        <div class="row custom-box-border-last p-2 align-items-center">
                            ...
                            <div class="col">
                                <img src="${pageContext.request.contextPath}/asserts/images/Mobiles/specification/desc-display-mi.webp" class="img-fluid" alt="">
                            </div>
                        </div>
                       ...
                       <div class="row">
                        <div class="col-12">
                            ...
                            <div class="row p-3 custom-box-border">
                                ...
                                <div class="row mt-3">
                                    <div class="col-2 p-2">
                                        <img src="${pageContext.request.contextPath}/asserts/images/Mobiles/customer-review/redmi-review.png" class="img-fluid" alt="">
                                    </div>
                                    <div class="col-2 p-2">
                                        <img src="${pageContext.request.contextPath}/asserts/images/Mobiles/customer-review/redmi-review.png" class="img-fluid" alt="">
                                    </div>
                            ...
                            <div class="row custom-box-border p-3 pt-4">
                                ...
                                <div class="row">
                                    <div class="col-2 px-4 d-flex">
                                        <img src="${pageContext.request.contextPath}/asserts/images/Mobiles/customer-review/redmi-review.png" class="img-fluid px-2" alt="">
                                        <img src="${pageContext.request.contextPath}/asserts/images/Mobiles/customer-review/redmi-review.png" class="img-fluid px-2" alt="">
                                        <img src="${pageContext.request.contextPath}/asserts/images/Mobiles/customer-review/redmi-review.png" class="img-fluid px-2" alt="">
                                    </div>
                                </div>
