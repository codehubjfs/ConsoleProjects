            ...
            <div class="row px-0 mx-0">
                <div class="col-12 mt-0 px-0 pb-5">
                    <div class="row rounded-top">
                        <div class="col-5">
                            <img src="${pageContext.request.contextPath}/asserts/images/logo.png" height="100" width="200" class="img-fluid rounded-top" alt="">
                        </div>
                        <div class="col-7 ">
                    ...
                    <form action="customerValidate" method="post" id="loginForm">
                        ...
                        <div class="text-center mt-4">
                            ...
                            <button type="button" class="btn bg-outline-custom2 btn-lg rounded-pill px-5" onclick="location.href='${pageContext.request.contextPath}/customerRegister'">Sign up</button>
