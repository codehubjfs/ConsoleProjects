                    ...
                    <div class="container table-responsive">
                        ...
                        <table class="table  table-bordered text-center" id="product-table">
                            ...
                            <c:forEach var="product" items="${productList}" varStatus="status">
                                <tr data-filter="${product.verificationStatus}">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="ProductManagementEditController">
                <div class="modal-body">
                	<input type="hidden" class="productsId" name="pid" value="">
                	<input type="hidden" name="product" value="DELETED">
    ...
    <script>
        ...
        document.querySelectorAll('.save-btn').forEach(button => {
            button.addEventListener('click', function () {
                ...
                location.href = "${pageContext.request.contextPath}/ProductManagementEditController?product="+statusSelect.value+"&pid="+pid.textContent;
            });
        });
