                ...
                <div class="row p-3 bg-white mb-3">
                    <div class="col d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="updation-status"><%= request.getParameter("cart-update-status")!=null?request.getParameter("cart-update-status"):"" %></p>
                        </div>
                        <div>
         		...
         		<c:set var="cart" value="${user.myCart}"/>
                    ...
                    <div class="row p-2 mt-4 mb-3 ">
                        <div class="col d-flex align-items-center">
                            <div class="col-auto d-flex box-one align-items-center">
                                <div>
                                <form action="CartProductIncrementController" method="post">
                                ...
                                <div>
                                    <input class="mx-1 cart-count text-center fw-bold" name="count" type="number" min="1" max="10" value="${product.value.quantity }">
                                </div>
                                <div>
	                                <form action="CartProductDecrementController" method="post">
	                                	<input type="hidden" name="pId" value="${product.key}">
           ...
           <!--     <div class="row bg-white  p-4 card-product">
                ...
                <div class="row bg-white p-3 shadow sticky-bottom  z-index container-order">
                    <div class="col d-flex justify-content-end">
                    	<form action="${pageContext.request.contextPath}/ProductMakeOrderController" method="post">
    ...
    <div class="modal fade" id="confirmRemove" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="CustomerCartDeleteController" method="post">
