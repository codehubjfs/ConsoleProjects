...
<head>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/asserts/css/adminstyles.css">
...
<body>
        ...
        <div class="row align-items-center">
            <div class="text-start col-12">
                <a class="navbar-brand" href="#">
                    <img class="img-fluid" src="${pageContext.request.contextPath}/asserts/images/logo.png" height="122" width="216" alt="MDB Logo"/>
                </a>
            </div>
        </div>
    </nav>
    ...
    %>
        <div id="outer-boxx" class="bg-white  shadow rounded">
            <div class="row px-0 mx-0">
				...
				<!-- 	<button type="button" id="go-dashboard">dash</button>  -->
                </div>
            </div>
        </div> 
    </div>
    ...
    <script>
     ...
     /*   document.querySelector('#go-dashboard').addEventListener('click',()=>{
        	window.open('${pageContext.request.contextPath}/validateCredential');
        }); */
    </script>
</body>
</html>
