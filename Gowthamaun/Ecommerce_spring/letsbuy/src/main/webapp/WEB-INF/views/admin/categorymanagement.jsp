...
<head>
   ...
   <script type="text/javascript" src="${pageContext.request.contextPath}/asserts/js/script.js"></script>
    <!-- Data Table CSS -->
                ...
                <div class="pt-0 px-0">
                  <div class="logo-divv">
                    <a class="navbar-brand" href="#">
                      <img class="img-fluid logo-img" src="${pageContext.request.contextPath}/asserts/images/logo.png" alt="MDB Logo" loading="lazy" />
                    </a>
                  </div>
                        ...
                        <div class="container mt-4 mb-4">
                            ...
                            <c:forEach var="category" items="${categoryList}" varStatus="status">
                                    ...
                                    <tr>
                                        ...
                                        <form action="CategoryManagementEditController" method="post">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                	...
                	<input type="hidden" id="cId" name="category-id" value="">
                	<input type="hidden" name="v-status" value="DELETED">
...
function isCategoryNameValid() {
    var categoryName = document.getElementById('addCategoryName').value.trim().toUpperCase();
    console.log(categoryName);

    let match = /^[a-zA-Z]{4,40}$/; // Updated regex to ensure it matches the full string
	let lengthMatch = /^.{4,40}$/;
	let allLetter = /^[a-zA-Z]*$/;
    // Cache the DOM elements
    var btn = document.getElementById('category-add');
    var msg = document.getElementById('message');
    
    const tableCategoryNames = Array.from(document.querySelectorAll('.category-name'))
    .map(td => td.textContent.trim().toUpperCase());

    if (!allLetter.test(categoryName)) {
    	 msg.classList.remove('text-success');
         msg.classList.add('text-danger');
         msg.innerHTML = 'Invalid Category Name (name can have only alphabets)';
         btn.classList.add('disabled');
       
    }else if(!lengthMatch.test(categoryName)){
    	 msg.classList.remove('text-success');
         msg.classList.add('text-danger');
         msg.innerHTML = 'Category Name length should be between 4-40';
         btn.classList.add('disabled');
    }else if (tableCategoryNames.includes(categoryName)) {
        msg.classList.remove('text-success');
        msg.classList.add('text-danger');
        msg.innerHTML = 'Category name already exists!';
        btn.classList.add('disabled');
    } else {
